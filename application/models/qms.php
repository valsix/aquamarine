...
class Qms extends Entity
{
    ...
    function selectByParams($paramsArray = array(), $limit = -1, $from = -1, $statement = "", $order = "ORDER BY FORMAT_ID ASC")
    {
        $str = "SELECT  
                 A.FORMAT_ID, A.FORMAT, A.DESCRIPTION
                FROM FORMAT_QM A
                WHERE 1=1
				";
    ...
    {
        $str = "SELECT COUNT(FORMAT_ID) AS ROWCOUNT FROM FORMAT_QM A

...
class Company_profile extends Entity
{
    ...
    function insert()
    {
        ...
        $str = "INSERT INTO DOKUMEN_MARKETING(
    ...
    function update()
    {
        $str = "UPDATE DOKUMEN_MARKETING
                ...
                LAST_REVISI ='" . $this->getField("LAST_REVISI") . "',
    ...
    {
        $str = "SELECT  
                    A.DOCUMENT_ID, A.COMPANY_NAME, A.VESSEL_NAME, A.DESCRIPTION, A.PATH, A.LAST_REVISI, A.TYPE_OF_SERVICE, A.LOCATION, A.DATE_OPERATION,
                    A.CLASS_RULES
    ...
    {
        $str = "SELECT COUNT(DOCUMENT_ID) AS ROWCOUNT FROM DOKUMEN_MARKETING A

...
class Bussines_plan extends Entity
{
    ...
    function insert()
    {
        ...
        $this->setField("DOCUMENT_ID", $this->getNextId("DOCUMENT_ID", "DOKUMEN_BP"));

        $str = "INSERT INTO DOKUMEN_BP(
                DOCUMENT_ID, PERIOD, NAME, DESCRIPTION, PATH, LAST_REVISI )
			    VALUES (
                " . $this->getField("DOCUMENT_ID") . ",
                '" . $this->getField("PERIOD") . "',
                '" . $this->getField("NAME") . "',
    ...
    function update()
    {
        $str = "UPDATE DOKUMEN_BP
				SET
                PERIOD ='" . $this->getField("PERIOD") . "',
    ...
    {
        $str = "SELECT  
                    A.DOCUMENT_ID, A.PERIOD, A.NAME, A.DESCRIPTION, A.PATH, A.LAST_REVISI
                FROM DOKUMEN_BP A
                WHERE 1=1
				";
    ...
    {
        $str = "SELECT COUNT(DOCUMENT_ID) AS ROWCOUNT FROM DOKUMEN_BP A

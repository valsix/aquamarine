...
class Employment_contracts extends Entity
{
    ...
    function insert()
    {
        ...
        $str = "INSERT INTO DOKUMEN_KK(
                    DOCUMENT_ID, TYPE, NAME, DESCRIPTION, PATH, LAST_REVISI, TAHUN )
			    VALUES (
    ...
    {
        $str = "SELECT  
                     A.DOCUMENT_ID, A.TYPE, A.NAME, A.DESCRIPTION, A.PATH, TO_CHAR(A.LAST_REVISI, 'DD-MM-YYYY HH24:MI:SS'), TAHUN
                FROM DOKUMEN_KK A
                WHERE 1=1  AND A.DOCUMENT_ID IS NOT NULL
				";
    ...
    {
        $str = "SELECT  
                     A.DOCUMENT_ID, A.TYPE, A.NAME, A.DESCRIPTION, A.PATH, A.LAST_REVISI, TAHUN
                FROM DOKUMEN_KK A
                WHERE 1=1
				";
    ...
    {
        $str = "SELECT COUNT(DOCUMENT_ID) AS ROWCOUNT FROM DOKUMEN_KK A

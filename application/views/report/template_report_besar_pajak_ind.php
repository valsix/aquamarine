			...
			<table border="1" style="border-collapse: 1px solid black;text-align: center;width: 100%; font-size: 11px;font-family:Arial">
				<thead>
					<tr >
						...
						<th colspan="2" style="background-color: #808080" ><span style="color: white">JUMLAH </span> / AMOUNT</th>

					</tr>
					<tr>
						<td rowspan="2"  style="border-bottom: none;border: none;border-left: 1px solid black;padding: 10px" align="left"><b> FLOATING HOSE, REPLACE HOSE, TOWING HOSE & BLANKING PLUG SW VALVE <b> </td>
							<td> <em>Dollar <em> </td>
						<td> <em> IDR  </em></td>
				...
				<tbody>
					...
					?>
						<tr>
							<td align="left" style="padding: 10px;border: none;border-left: 1px solid black;border-right: 1px solid black"><b style="font-size: 15px;"><div><?=$nooo+1?>.) <?= $invoice_detail->getField('SERVICE_TYPE') ?></b><br>
								
								<ul style="padding-left: 40px;font-weight: normal;font-size: 12px">
							...
							<td style="border: none;border-left: 1px solid black;border-right: 1px solid black;text-align: right"> <?= $amount_usd ?> </td>
							<td style="border: none;border-left: 1px solid black;border-right: 1px solid black;text-align: right"> <?= $amount_idr ?></td>
				...
				<tfoot>
					...
					<tr>
						...
						<td><strong style="text-align: right"> <?= currencyToPage2($total_ppn_usd) ?> </strong></td>
					...
					<tr>
						<td align="right"><strong> PPH (<?= $reqPpnPercent ?>) % </strong></td>
					...
					$total_idr_payable= $total_idr - $reqDP + $total_ppn_idr;
					if ($total_usd == 0 )
					{
						$total_usd = 'null';	
					}
					...
					<tr>
					<td colspan="3" align="center"> <b> The Sum of : ## <?=terbilang($total_idr_payable)?> ##</b>  </td>
					</tr>
				</tfoot>
			</table>
		</div>
...
<table style="width: 100%;font-size: 11px;font-family:Arial;margin-left:-3px;">
	<tr>
		<td style="width: 50%;text-align: justify;font-size: 11px;" valign="top" ><b> Syarat & Ketentuan Umum </b>/ <em> General Terms & Conditions :</em> <br><br>
			Tagihan atas Invoice ini telah kami anggap selesai bila kami telah menerima pembayaran sesuai dengan box faktur / <em> This invoice is considered paid when we receive the payment as per stipulated within box Invoice </em><br><br>

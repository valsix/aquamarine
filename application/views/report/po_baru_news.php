...
<div class="row">
    <div class="col">
        <table border="1" style="font-size: 14px; width: 100%; border-collapse: 1px solid black;font-family: Calibri">
            ...
            <tbody>
                <tr>
                    <td style="text-align: center; width: 16%" valign="top"><?=$reqTypePo?> </td>
...
<div class="row">
    <div class="col">
        <table border="1" style="font-size: 14px; width: 100%; border-collapse: 1px solid black;font-family: Calibri">
            ...
            <tbody>
                <tr>
                    <td style="padding-left: 5px; width: 30%" valign="top">
                    ...
                    <td style="padding-left: 5px; width: 47%; vertical-align: top;">
                        <ul>
                            <span><b> PT. Aquamarine Divindo Inspection </b></span>
                        </ul>
                        <ul>
        ...
        <table border="1" style="font-size: 14px; width: 100%; border-collapse: 1px solid black;font-family: Calibri">
            <thead>
                <tr style="background-color: #C5C5C5;">
                    ...
                    <th style="padding-top: 5px; padding-bottom: 5px">QTY</th>
                    <th style="padding-top: 5px; padding-bottom: 5px">DESCRIPTION</th>
                    <th style="padding-top: 5px; padding-bottom: 5px">UNIT PRICE (<?=$reqCur?>)</th>
                    <th style="padding-top: 5px; padding-bottom: 5px">TOTAL (<?=$reqCur?>)</th>
            ...
            <tfoot>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    $total_total = $total_total-$reqDiskonPercent;
                    ?>
                    <td colspan="3" style="text-align: center;">Discount </td>
                  
                    <td style="text-align: center;"> </td>
                    <td style="text-align:right;"><?=currencyToPage2($reqDiskonPercent)?></td>

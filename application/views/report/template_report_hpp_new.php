          ...
          <tr>
                                <th rowspan="2" width="30" > # </th>
                                 <th rowspan="2" width="200"> Deskripsi </th>
                                  <th colspan="6" style="background-color: #FFFF70"> Pengeluaran  </th>
                                   <th colspan="6" style="background-color: #70D59B"> Pemasukan  </th>
                            </tr>
                            <tr>
                                <th width="10" style="background-color: #FFFF70">Qty   </th>
                                 <th  width="10" style="background-color: #FFFF70">Days    </th>
                                  <th style="background-color: #FFFF70" width="30">Status    </th>
                                  <th style="background-color: #FFFF70" >Harga Satuan     </th>
                                  <th  style="background-color: #FFFF70">Total Harian     </th>
                                  <th  style="background-color: #FFFF70" >Total Bulanan   </th>
                                  <th width="10" style="background-color: #70D59B">Qty   </th>
                                 <th width="10" style="background-color: #70D59B">Days    </th>
                            ...
                            ?>
                                <tr>
                                     ...
                                     <td valign="top" align="center"> <?=$val['k_qty']?> </td>
                                      <td valign="top" align="center"> <?=$val['k_day']?> </td>
                                      <td valign="top" align="center"> <?=$val['k_status']?> </td>
                                      <td valign="top" align="right"> <?=currencyToPage2($val['k_harga'])?> </td>
                                      <td valign="top" align="right"> <?=currencyToPage2($val['k_total'])?> </td>
                                       <td valign="top" style="background: #FFFF70" align="right"> <?=currencyToPage2($val['k_bulanan'])?> </td>
                            ...
                            ?>
                             <tr style="background: #BDD7EE">
                                        ...
                                        <td align="right"><?=currencyToPage2($totalHarian)?> </td>
                                         <td align="right"><?=currencyToPage2($totalBulanan)?> </td>
                                         <td colspan="3"> </td>
                                     ...
                                     <tr>
                                        <td valign="top" align="center"><?=$no;$no++?>. </td>
                                         <td valign="top" align="left" style="padding: 5px"> <?=$val2['keterangan']?> </td>
                                          <td valign="top" align="center"> <?=$val2['k_qty']?></td>
                                           <td valign="top" align="center"> <?=$val2['k_day']?></td>
                                           <td valign="top" align="center"> <?=$val2['k_status']?></td>
                                            <td valign="top" align="right"> <?=currencyToPage2($val2['k_harga'])?></td>
                                            <td valign="top" align="right"> <?=currencyToPage2($val2['k_total'])?></td>
                                             <td valign="top" style="background: #FFFF70" align="right"> <?=currencyToPage2($val2['k_bulanan'])?></td>
                        ...
                        $masuk_harian =      $arrKeyTotal['A']['m_harian'] + $arrKeyTotal['B']['m_harian'] + $arrKeyTotal['C']['m_harian'] + $arrKeyTotal['D']['m_harian'];
                         ...
                         $reqSubTotalKHarian = (int) $masuk_harian +$masuk_harian2;
                           $reqSubTotalMHarian = (int) $keluar_harian +$keluar_harian2;
                            ?>
                            <tr>
                                <td colspan="6" align="RIGHT"> <b>SUBTOTAL A+B+C+D </b>  </td>
                                <td align="right"><?=currencyToPage2($keluar_harian) ?></td>
                                <td align="right"><?=currencyToPage2($grandTotalPengeluaranAbcd) ?></td>
                                <td colspan="3"> </td>
                                <td align="right"><?=currencyToPage2($grandTotalPengeluaranAbcd) ?></td>
                                <td align="right"><?=currencyToPage2($grandTotalPemasukanAbcd) ?></td>
                            </tr>
                            <tr>
                                <td colspan="6" align="RIGHT"> <b>SUBTOTAL E + F  </b>  </td>
                                <td align="right"><?=currencyToPage2($keluar_harian2) ?></td>
                                <td align="right"><?=currencyToPage2($grandTotalPengeluaranEf) ?></td>
                                <td colspan="3"> </td>
                              ...
                              <tr>
                                ...
                                <td align="right"><?=currencyToPage2($reqSubTotalKHarian) ?></td>
                                <td align="right"><?=currencyToPage2($reqSubTotalKeluar) ?></td>
                                <td colspan="3"> </td>
                                <td align="right"><?=currencyToPage2($reqSubTotalMHarian) ?></td>
                                <td align="right"><?=currencyToPage2($reqSubTotalMasuk) ?></td>
                            </tr>
                            <tr>
                                <td colspan="6" align="RIGHT"> <b>PROFIT   </b>  </td>
                                <td ></td>
                                <td align="right"><?=currencyToPage2($grandTotalProfit) ?></td>
                                <td colspan="3"> </td>
                                <td >-</td>
                                <td >-</td>
                            </tr>

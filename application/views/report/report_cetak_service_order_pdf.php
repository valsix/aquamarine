...
$add_str = 'reqCariNoOrder=' . $reqCariNoOrder . '&';
...
$add_str .= 'reqCariGlobalSearch=' . $reqCariGlobalSearch . '';
...
$html = file_get_contents($this->config->item('base_report')."report/index/report_cetak_service_order/?=".$add_str);

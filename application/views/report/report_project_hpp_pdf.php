...
$mpdf->SetHTMLHeader('
	...
	<img src="images/logo_baru.jpeg" style="height: 50px;width: 70px">
	</div>
	</td>
...
$html = file_get_contents($this->config->item('base_report') . "report/index/report_project_hpp/?reqId=" . $reqId . "&reqMode=" . $reqMode);

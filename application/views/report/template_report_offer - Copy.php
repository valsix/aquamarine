 ...
 <center>
     <div class="row">
         <div class="col">
             <table style="border-collapse: 1px solid black">
                 <tr>
                     <td style="width: 100px;"><small><strong> Kepada Yth. </strong></small></td>
                     <td style="width: 25px;"></td>
 ...
 <center>
     <div class="row">
         <div class="col">
             <table>
                 <tr>
                     <td style="width: 111px;">Dengan Hormat,</td>
                     <td style="width: 25px;"></td>
                     <td style="width: 100px;"></td>
                     <td style="width: 175px;"></td>
 ...
 <center>
     <div class="row">
         <div class="col">
             <table>
                 <tr>
                     <td style="width: 988px;" align="justify">Terima kasih atas kepercayaan <strong><?= $reqCompanyName ?> </strong> untuk mengunakan pekerjaan <strong> <?= $reqTypeOfService ?> </strong> di perusahaan kami, berdasarkan informasi by phone, dengan ini kami menawarkan harga sesuai detail di bawah ini: </td>
                 </tr>
             </table>
         </div>
     </div>
 ...
 <center>
     <div class="row">
         <div class="col">
             <table>
                 <tr>
                     <td style="width: 140px;"><strong> Scope Pekerjaan </strong></td>
                     <td style="width: 25px;">:</td>
 ...
 <center>
     <div class="row">
         <div class="col">
             <table>
                 <tr>
                     <td style="width: 140px;"><strong> Metode Pembayaran </strong></td>
                     <td style="width: 25px;">:</td>
                     <td style="width: 812px;"></td>
                 </tr>
             </table>
         ...
         <div class="col">
             <table>
                 <tr>
                     <td style="width: 50px;"></td>
                     <td colspan="2">
                         <smal><small> <?= $reqPaymentMethod ?> </small></smal>
                     </td>
 ...
 <center>
     <div class="row">
         <div class="col">
             <table>
                 <tr>
                     <td style="width: 988px;" align="justify">Terima kasih atas perhatiannya, kami berharap dapat tetap terjalin kerjasama yang baik antara perusahaan kami dengan <strong> <?= $reqCompanyName ?> </strong> mohon keputusannya dan untuk segera mengirim Working Order (WO).</td>
                 </tr>
             </table>
         </div>
     </div>

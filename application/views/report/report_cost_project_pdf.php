...
$reqHppId = $this->input->get("reqHppId");
...
if(empty($reqHppId)){
$html = file_get_contents($this->config->item('base_report') . "report/index/report_cost_project/?reqId=" . $reqId . "&reqMode=" . $reqMode);
}else{
	$html = file_get_contents($this->config->item('base_report') . "report/index/report_cost_project_hpp/?reqId=" . $reqId . "&reqMode=" . $reqMode);
}
...
$mpdf->Output('cost_project.pdf', 'I');
exit;
//==============================================================
//==============================================================
//==============================================================

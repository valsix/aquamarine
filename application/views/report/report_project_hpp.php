...
<table style="width: 100%;font-size: 12px;font-family: Arial;border:1px solid black;border: 1px inset black;
    ...
    border-spacing: 0;" BORDER="1" >
        ...
        <?
        if(!empty( $reqStatusApproved)){
        ?>
        <tr>
            <td style="height: 100px"><h3 ><b> For Aproved </b> </h3><br><br><br><?=$reqForApproved?> </td>
             <td> &nbsp;&nbsp;&nbsp; </td>
              <td> <h3 ><b>  Aproved </b> </h3><br> <img src="images/ttd_ynafik.png"><br>IR. Yunus Nafik  </td>
        </tr>
        <?
        }else{
        ?>
        <tr>
            <td style="height: 100px"><h3 ><b> </b> </h3><br><br><br><?=$reqForApproved?> </td>
             <td> &nbsp;&nbsp;&nbsp; </td>
              <td> &nbsp;&nbsp;&nbsp;  </td>
        </tr>
   ...
   <!--  <table style="width: 100%;font-size: 12px;font-family: Arial;border:1px solid black;border: 1px inset black;
    ...
    border-spacing: 0;" BORDER="1" >
        <tr>
            <td style="width: 100px">For Aproved  </td>
             <td style="width: 100px">For Execution </td>
              <td style="width: 100px">Aproved </td>
        </tr>
        <tr>

...
// 	<img src="images/logo_news2.png" style="height: 80px;width: 100%">
// 	</div>
// 	</td>
...
// LOAD a stylesheet
$stylesheet = file_get_contents(base_url() . 'css/gaya_laporan.css');
$mpdf->WriteHTML($stylesheet, 1);    // The parameter 1 tells that this is css/style only and no body/html/text

//$html = file_get_contents("http://rais.teluklamong.co.id/report/index/berita_acara/?reqId=".$reqId);

// $html = file_get_contents($this->config->item('base_report') . "report/index/offer_realisasi/?reqId=" . $reqId);
// ECHO $_SESSION["reqStatementOfferRealisasi"];exit;
$arData = array('STATEMENT'=>$_SESSION["reqStatementOfferRealisasi"]);
$html = $this->load->view('report/offer_realisasi',$arData,true);

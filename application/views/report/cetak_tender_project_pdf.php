...
$aColumnsAlias =  array('NO', "PROJECT_NO","CLIENT_NAME", "PROJECT_NAME", "STATUS", "DATE ISSUED ANNOUNCEMENT", "REGISTER DATE & COLLECT DOCUMENT", 
...
// }
 $reqAnnouncement            =  $this->input->get('reqAnnouncement2');
if (!empty($reqAnnouncement)) {

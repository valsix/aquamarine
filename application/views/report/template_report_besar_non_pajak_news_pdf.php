...
if($reqBahasa=='eng'){
	// $html = file_get_contents($this->config->item('base_report') . "report/index/template_report_besar_pajak_eng/?reqId=" . $reqId . "&reqMode=" . $reqMode);
}else{
	$html = file_get_contents($this->config->item('base_report') . "report/index/template_report_besar_pajak_eng_new/?reqId=" . $reqId . "&reqMode=" . $reqMode);
}

...
$reqTermsAndCondition = str_replace('<ol>', '<ol style="font-size: 14px;font-family: Calibri">', $reqTermsAndCondition);

$pattern = '/<span style="font-size.+">(.+)<\/span>/';
$replacement = '${1}';

$reqTermsAndCondition = preg_replace($pattern, $replacement, $reqTermsAndCondition);

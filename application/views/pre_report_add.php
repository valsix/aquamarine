...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/pre_report">Monitoring Of Underwater/UWILD</a> &rsaquo; Form Monitoring Of Underwater/UWILD
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Form Underwater/UWILD
                        ...
                        <tbody id="tambahAttacment">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" onchange="getFileName(this, '<?=($i+1)?>')" name="document[]" class="form-control" style="width: 90%">
                                            <input type="hidden" name="reqLinkFileTemp[]" value="<?= $files_data[$i] ?>">
                                            <?if ($ext !=='pdf')
                                            {
                                            ?>
                                              <a href="uploads/pre_report/<?= $reqId ?>/<?= $files_data[$i] ?>" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            else
                                            {
                                            ?>
                                              <a onclick="openAdd('uploads/pre_report/<?= $reqId ?>/<?= $files_data[$i] ?>');" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            ?>
                                        </td>
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    if(datas[0]=='xxx'){
                       ...
                       $.messager.alertLink('Info', datas[1], 'info', "app/index/pre_report_add?reqId=" + datas[0]); 
                    }

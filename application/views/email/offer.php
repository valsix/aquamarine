						...
						<tr>
							<td align="center" valign="top">
								...
								<!--
									...
									-->
								<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#000;" bgcolor="#FFFFFF">
									<tr>
										<td align="center" valign="top">
											<!-- FLEXIBLE CONTAINER // -->
											<!--
												...
												<tr>
													<td align="center" valign="top" width="500" class="flexibleContainerCell">
														...
														<!--
															...
															-->
														<table border="0" cellpadding="30" cellspacing="0" width="100%" style=" background:#aaaaaa">
															<tr>
																<td align="center" valign="top" class="textContent">
																	<h2 class="title-career" style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:20px;margin-bottom:15px;color:#000;line-height:135%; border-top:1px solid #2b8dce; border-bottom:1px solid #2b8dce; padding-top:10px;padding-bottom:7px;">PT - AQUAMARINE DIVINDO INSPECTION</h2>
																	<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000; letter-spacing:2px; line-height:135%;">Email Notifikasi
																	</div>
																</td>
															</tr>
														</table>
															...
															<tr>
																<td valign="top">
																	...
																	<table style="font-size: 10px;width: 100%">
																		<tr>
																			<td style="width: 70%"><?=$reqNoOrder?> </td>
																			<td style="width: 30%">Sidoarjo , <?=$reqDateOfOrder?> </td>
																		</tr>
																	</table>
																	<br>
																	<br>
																	<b style="font-size: 10px;width: 100%">Kepada :</b>
																	<br>
																	<b style="padding-left: 20px;font-size: 10px;">Yth . <?=$reqDocumentPerson?> </b>
																	<br>
																	<b style="padding-left: 20px;font-size: 10px;"><?=$reqCompanyName?> </b>
																	<br>
																	<b style="padding-left: 20px;font-size: 10px;"><?=$reqHp?> </b>
																	<br>
																	<br>
																	<p style="font-size: 10px;width: 100%">Dengan Hormat,</p>

																	<p style="font-size: 10px;width: 100%">Terima kasih atas kepercayaan <b> <?=$reqCompanyName?></b> untuk mengunakan pekerjaan <em> <?=$reqTypeOfService?> </em> di perusahaan kami, berdasarkan informasi by phone , dengan ini kami menawarkan harga sesuai detail di bawah ini :</p>
																	<table style="width: 100%;font-size: 9px;">
																		...
																		<tr>
																			...
																			<td> : </td>
																			<td> <?=$reqDateOfService?> </td>
																		</tr>
																		<tr>
																			<td> Type of Service </td>
																			<td> : </td>
																			<td> <?=$reqTypeOfService?> </td>
																		</tr>
																		<tr>
																			<td> Price </td>
																			<td> : </td>
																			...
																			?>
																			<td> <?=$text?>/ Vessel ( <?=$reqTotalPriceWord?> ) </td>
																		</tr>
																	</table>
																	<br>
																	<b style="font-size: 9px;"> Scope Pekerjaan </b><br>
																	<b style="padding-left: 20px;font-size: 9px;"><?=$reqScopeOfWork?> </b>
																	<br>
																	<b style="font-size: 9px;"> Term & Conditions </b><br>
																	<b style="padding-left: 20px;font-size: 9px;"><?=$reqTermAndCondition?> </b>
																	<br>
																	<b style="font-size: 9px;"> Metode Pembayaran </b><br>
																	<b style="padding-left: 20px;font-size: 9px;"><?=$reqPaymentMethod?> </b>
																	<br>
																	<p style="font-size: 9px;"> Terima Kasih atas perhatiannya , kami berharap dapat tetap terjalin kerjasama yang baik antara perusahaan kami dengan <?=$reqCompanyName?>. Mohon keputusannya dan untuk segera mengirim Working Order ( WO ) </p>
																	<br>

																	<p style="font-size: 10px;"> Best Regards </p>
																	<img src="cid:logo_mynotescode" />

																	<p style="font-size: 10px;"><b><u> <?=$reqMaker?> </u></b> </p>
											...
											<table border="0" cellpadding="0" cellspacing="0" width="500" class="flexibleContainer">
												<tr>
													<td align="center" valign="top" width="500" class="flexibleContainerCell">
														<table border="0" cellpadding="30" cellspacing="0" width="100%">
															<tr>
																<td valign="top" style="background:#074162">

																	<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#FFF;text-align:center;line-height:120%;">
																		<div>Copyright &#169; 2020 <a href="<?= base_url() ?>" target="_blank" style="text-decoration:none;color:#FFF;"><span style="color:#FFF;">AQUAMARINE - PT - AQUAMARINE DIVINDO INSPECTION</span></a>. All&nbsp;rights&nbsp;reserved.</div>
																	</div>

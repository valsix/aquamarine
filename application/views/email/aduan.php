...
$reqId = $reqParse1;
$aduan->selectByParamsMonitoring(array("A.ADUAN_ID"=>$reqId));
$aduan->firstRow();
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%" style=" background:#aaaaaa">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;"><img src="<?=base_url()?>images/logo.png" style="margin:0 auto; height:150px" /></h1>
																		
                                                                        <h2 class="title-career" style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:20px;margin-bottom:15px;color:#000;line-height:135%; border-top:1px solid #2b8dce; border-bottom:1px solid #2b8dce; padding-top:10px;padding-bottom:7px;">SEKAR - PERUM BULOG</h2>
                                                                        
																		<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#000; text-transform:uppercase; letter-spacing:2px; line-height:135%;">ADUAN ANGGOTA</div>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
																			...
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
																					 <p style="text-align:justify">Aplikasi SEKAR telah menerima aduan dengan informasi :  																				      </p>
                                                                                      <table style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;">
                                                                                        ...
                                                                                        <td style="width: 5%">:</td>
                                                                                        <td style="width: 75%"><?=$aduan->getField("NIP_NAMA")?></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        <td style="width: 3%; vertical-align:top">b)</td>
                                                                                        <td style="width: 20%; vertical-align:top">Judul</td>
                                                                                        <td style="width: 5%; vertical-align:top">:</td>
                                                                                        <td style="width: 75%"><?=$aduan->getField("NAMA")?></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        <td style="width: 3%; vertical-align:top">c)</td>
                                                                                        <td style="width: 20%; vertical-align:top">Aduan</td>
                                                                                        <td style="width: 5%; vertical-align:top">:</td>
                                                                                        <td style="width: 75%"><?=$aduan->getField("ADUAN")?></td>
                                                                                        </tr>
                                                                                        <?
                                                                                        if($aduan->getField("LINK_FILE") == "")
																						{}
																						else
																						{
																						?>
                                                                                        ...
                                                                                        <td style="width: 5%">:</td>
                                                                                        <td style="width: 75%"><a href="<?=base_url()?>/uploads/<?=$aduan->getField("LINK_FILE")?>">download</a></td>
                                                                                        </tr>
                                                                                        <?
																						}
																						?>
                                                                                      ...
                                                                                      <p style="text-align:justify">Demikian yang dapat kami sampaikan. Atas perhatiannya kami ucapkan Terima Kasih.</p>
																...
																<tr>
																	<td valign="top" style="background:#074162">
																		...
																		<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#FFF;text-align:center;line-height:120%;">
																			<div>Copyright &#169; 2020 <a href="<?=base_url()?>" target="_blank" style="text-decoration:none;color:#FFF;"><span style="color:#FFF;">SEKAR - PERUM BULOG</span></a>. All&nbsp;rights&nbsp;reserved.</div>
																		</div>

														...
														<table border="0" cellpadding="30" cellspacing="0" width="100%">
															<tr>
																<td valign="top">
																	...
																	<br>
																	<br>
																	<b style="font-size: 10px;width: 100%">To :</b>
																	<br>
																	<b style="padding-left: 20px;font-size: 10px;">Dear . <?=$reqDocumentPerson?> </b>
																	<br>
																	...
																	<br>
																	<br>
																	<p style="font-size: 10px;width: 100%">Sincerely,</p>

																	<p style="font-size: 10px;width: 100%">Thank you for trust <b> <?=$reqCompanyName?></b> to use work <em> <?=$reqTypeOfService?> </em> in our company, based on information by phone , hereby we offer the price according to the detail below  :</p>
																	...
																	<br>
																	<b style="font-size: 9px;"> Scope of Work </b><br>
																	...
																	<br>
																	<b style="font-size: 9px;"> Payment method  </b><br>
																	<b style="padding-left: 20px;font-size: 9px;"><?=$reqPaymentMethod?> </b>
																	<br>
																	<p style="font-size: 9px;"> Thank you for your attention , we hope to continue to establish good cooperation between our company and <?=$reqCompanyName?>. Please make a decision and to send Working immediately

...
<html lang="en">
  <head>
    ...
    <!-- VEGAS -->
    <link rel="stylesheet" type="text/css" href="libraries/vegas/jquery.vegas.min.css">
  ...
  <body>
    ...
    <div class="container-fluid">
    	<div class="row">
        	<div class="col-md-3 area-login-kiri">
                <div class="inner">
                	<div class="logo">
            ...
            <div class="col-md-9 area-login-kanan">
				<form class="form-signin" method="post" action="login/action">
                	<span class="icon-user"><img src="images/icon-user-login.png"></span>

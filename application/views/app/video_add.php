...
else
{
	...
	$reqLinkFileVideo				= $slider->getField("LINK_FILE_VIDEO");
}
?>
...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/video">Video</a> &rsaquo; Kelola Video</div>   
    ...
    <div class="konten-area">
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <textarea class="form-control" name="reqKeterangan" style="width:100%; height:200px"><?=$reqKeterangan ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="reqKeterangan" class="control-label col-md-2">File Preview</label>
                        <div class="col-md-9">
                            <div class="form-group">
                                <div class="col-md-11">
                                    ...
                                    <input name="reqLinkFile[]" type="file" maxlength="1"  class="multi with-preview maxsize-1024" accept="jpg|jpeg" value=""/>               
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="divFile"  >
                        <label for="reqKeterangan" class="control-label col-md-2">Link URL video format MP4 (bukan youtube)</label>
                        <div class="col-md-9">
                            <div class="form-group">
                                <div class="col-md-11">
                                	<input type="hidden" name="reqTipe" value="FILE">
                                    <input name="reqAlamatVideo" id="reqAlamatVideo" type="text" class="easyui-validatebox textbox form-control" style="width:80%" value="<?=$reqLinkFileVideo?>" />               
                                    <?
                                    if($reqLinkFileVideo == "")
									{}
									else
									...
									?>                             
                                    <br>       
                                    <span><a href="<?=$reqLinkFileVideo?>" target="_blank">lihat video</span>
                                    <?
									}?>         
                                </div>
                            </div>
                    ...
                    <input type="hidden" name="reqJenis" value="VIDEO" />
		...
		<script>
            function submitForm(){
                ...
                $('#ff').form('submit',{
					url:'web/slider_json/add_video',
                    onSubmit:function(){
                        return $(this).form('enableValidation').form('validate');
                    },
					success:function(data){
						//alert(data);
						$.messager.alertLink('Info', data, 'info', "app/index/video");	
					}
                });
            }
            function clearForm(){

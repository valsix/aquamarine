...
$aColumns = array(
    "USERID", "USERNAME", "FULLNAME",  "LEVEL", "MENU_WAREHOUSE","MENU_MARKETING", "MENU_FINANCE", "MENU_PRODUCTION", "MENU_DOCUMENT", "MENU_RESEARCH", "MENU_OTHERS"
);
...
<script type="text/javascript" language="javascript" class="init">
  ...
  null,
            ...
            "sAjaxSource": "web/users_management_json/json",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anSelectedId = element[0];
            document.location.href = "app/index/users_management_add?reqId=" + anSelectedId;

            // console.log(anIndex);
        });

        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/users_management_add";
        ...
        $('#btnDelete').on('click', function() {
            if (anSelectedData == "")
                return false;
            deleteData("web/users_management_json/delete", anSelectedId);
        });


        $('#btnPrint').on('click', function() {
            openAdd('app/loadUrl/report/cetak_user_management_pdf?<?= $add_str ?>');
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Users Management</div>
                ...
                <div class="panel-body" style="padding: 10px">
                    <form id="ffs" class="easyui-form form-horizontal" method="post" data-options="novalidate:true">
                        <table id="tablei" style="width: 100%;padding: 10px;margin:10px">
                            ...
                            <tr>
                                <td>Username </td>
                                <td colspan="2"><input type="text" name="reqCariVasselName" class="form-control" id="reqCariVasselName" value="<?= $reqCariVasselName ?>"></td>

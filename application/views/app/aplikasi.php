...
$aColumns = array("APLIKASI_ID","PUBLISH","NAMA","JENIS","LINK_APLIKASI","ICON", "DITULIS_OLEH");
?>
...
<script type="text/javascript" language="javascript" class="init">	
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/aplikasi_json/json",		
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
				  document.location.href = "app/index/aplikasi_add";  		
			  });
			  
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;	
				  document.location.href = "app/index/aplikasi_add?reqId="+anSelectedId;  			
			  ...
			  $('#btnDelete').on('click', function () {
				  ...
				  deleteData("web/aplikasi_json/delete", anSelectedId);
			  ...
			  $('#btnPublish').on('click', function () {
				  ...
				  konfirmasiAksi(pesan, "web/aplikasi_json/publish", anSelectedId+"&reqStatus="+status);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">  Aplikasi</div>

...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/document_json/json?<?= $add_str ?>&pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0, 1, 4, 5]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/standarisasi_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/standarisasi_add";
  ...
  var add_str = "&reqCariCompanyName="+$("#reqCariCompanyName").val() ;            
      add_str += "&reqCariDescription="+$("#reqCariDescription").val();
            ...
            openAdd('app/loadUrl/report/cetak_standarisasi_pdf?<?=$add_str?>'+add_str);
            // openAdd('report/index/report_cetak_project_cost_pdf?reqId=' + anSelectedId);
        });

        $('#btnImport').on('click', function() {
            openAdd("app/loadUrl/app/import_template_standarisasi");
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Monitoring Document of Standarisasi</div>
                ...
                <div class="panel-body" style="padding: 10px">
                    <form id="ffs" class="easyui-form form-horizontal" method="post" data-options="novalidate:true">
                        <table id="tablei" style="width: 100%;padding: 10px;margin:10px">
                            ...
                            <tr>
                                <td>Description </td>
                                <td colspan="2"><input type="text" name="reqCariDescription" class="form-control" id="reqCariDescription" value=""></td>

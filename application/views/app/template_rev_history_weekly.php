...
// );
$aColumns = array("
           WEEKLY_PROSES_HISTORY_ID","NO","SOLUSI","PROSES","DUE_DATE","PIC_PERSON","DUE_PIC","STATUS");
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/weekly_proses_history_json/json?reqCal=1&reqId=<?=$reqId?>",
            columnDefs: [{
                className: 'never',
                targets: [0,7]
            }],
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Meeting History</div>

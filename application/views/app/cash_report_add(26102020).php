...
$aColumns = array("CASH_REPORT_DETIL_ID", "TANGGAL", "KETERANGAN", "PELUNASAN", "NO_REK", "DEBET ( RP. )", "KREDIT ( RP. )", "BALENCE ( RP. )", "CASH_REPORT_ID", "KATEGORI_ID","DEBET ( USD )","KREDIT (USD )","BALENCE (USD)", "AKSI");
...
<div class="col-md-12">
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <label for="reqNoRek" class="control-label col-md-2">Account Number </label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input type="text" id="reqPelunasan" class="easyui-validatebox form-control" name="reqPelunasan" value="" style=" width:100%" />
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function editing(id) {
            ...
            if(debet_usd==0 || debet_usd=='' || debet_usd==null){
                
                 $('#reqRealCurDebit').combobox('setValue', 'IDR');
                  $('#reqRealCurKredit').combobox('setValue', 'IDR');
            }

            if(kredit_usd==0 || kredit_usd=='' || kredit_usd==null ){
                 $('#reqRealCurDebit').combobox('setValue', 'IDR');
                 $('#reqRealCurKredit').combobox('setValue', 'IDR');
            }

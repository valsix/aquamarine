...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/material_invoice_json/json?<?= $add_str ?>&pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0,3]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/material_invoice_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/material_invoice_add";
        ...
        $('#btnDelete').on('click', function() {
            ...
            deleteData_for_table('web/material_invoice_json/delete', anSelectedId, anIndex, 1);
            // deleteData("web/material_invoice_json/delete", anSelectedId);
        });
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_material_invoice_pdf?'+add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Pembelian dan Pembayaran Material</div>

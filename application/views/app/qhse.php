...
"orderable": false
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/qhse_add?reqId=" + anSelectedId;

            // console.log(anIndex);
        });

        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/qhse_add";
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_qhse_pdf?<?= $add_str ?>'+add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Monitoring Document of QHSE</div>

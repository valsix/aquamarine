...
if ($reqId == "") {
    ...
    $reqMode = "ubah";
    $bussinesPlan->selectByParams(array("DOCUMENT_ID" => $reqId));
    $bussinesPlan->firstRow();

    $reqPeriod = $bussinesPlan->getField("PERIOD");
    $reqName = $bussinesPlan->getField("NAME");
    $reqDescription = $bussinesPlan->getField("DESCRIPTION");
    $reqPath = $bussinesPlan->getField("PATH");
    $reqLastRevisi = $bussinesPlan->getField("LAST_REVISI");
}
?>
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/bussines_plan"> Bussines Plan</a> &rsaquo; Form Bussines Plan
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="reqPeriod" class="control-label col-md-2">Period</label>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">


                                    <input class="easyui-combobox form-control" style="width:100%" name="reqPeriod" data-options="width:'200',editable:false, valueField:'id',textField:'text',url:'combo_json/comboPeriod'" value="<?= $reqPeriod ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <textarea name="reqDescription" id="reqDescription" style="width: 100%;" required="true"><?= $reqDescription; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {
                                            ?>
                                              <a href="uploads/bussines_plan/<?= $reqId ?>/<?= $files_data[$i] ?>" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            else
                                            {
                                            ?>
                                              <a onclick="openAdd(`uploads/bussines_plan/<?= $reqId ?>/<?= $files_data[$i] ?>`);" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            ?>
                                        </td>
                    ...
                    <input type="hidden" name="reqTipe" value="Bussines_plan" />
    ...
    <script>
        function submitForm() {
            ...
            $('#ff').form('submit', {
                url: 'web/bussines_plan_json/add',
                onSubmit: function() {
                ...
                success: function(data) {
                    ...
                    $.messager.alertLink('Info', datas[1], 'info', "app/index/bussines_plan_add?reqId=" + datas[0]);
                    }

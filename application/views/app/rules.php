...
$aColumns = array(
    "DOCUMENT_ID",  "NAME","CLASS_RULES", "DESCRIPTION", "PATH", "LAST_REVISI"
);
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "responsive":true,
            "sAjaxSource": "web/rules_json/json?pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/rules_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/rules_add";
        });
        ...
        $('#btnDelete').on('click', function() {
            if (anSelectedData == "")
                return false;
            deleteData_for_table('web/rules_json/delete', anSelectedId, anIndex, 1);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Rules & Regulation</div>
                ...
                <div class="panel-body" style="padding: 10px">
                    <form id="ffs" class="easyui-form form-horizontal" method="post" data-options="novalidate:true">
                        <table id="tablei" style="width: 100%;padding: 10px;margin:10px">
                            <tr>
                                <td>Name </td>
                                <td><input type="text" name="reqCariCompanyName" class="form-control" id="reqCariNoOrder" value="<?= $reqCariCompanyName ?>"></td>
                                <td> Find Method</td>
                                <td><select class="form-control">
                                        <option value=""> </option>
                                        <option value="Application">Application</option>
                                        <option value="FileConten">File Content</option>

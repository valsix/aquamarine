...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/slider">Berita</a> &rsaquo; Kelola Berita</div>   
    	...
    	<div class="konten-inner">
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="reqJenis" value="SLIDER" />
            ...
            function submitForm(){
                ...
                $('#ff').form('submit',{
					...
					success:function(data){
						//alert(data);
						$.messager.alertLink('Info', data, 'info', "app/index/slider");	
					}
                });
            }
            function clearForm(){

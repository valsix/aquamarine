...
$aColumns = array("SLIDER_ID","PUBLISH","NOTIF","TANGGAL","NAMA","KETERANGAN","GAMBAR", "DITULIS_OLEH");
?>
...
<script type="text/javascript" language="javascript" class="init">	
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/slider_json/json/?reqJenis=VIDEO",		
			...
			/* Click event handler */
			  ...
			  $("#example tbody").click(function(event) {
					  ...
					  anSelectedNotif = element[3];
			  });
			  
			  
			  $('#btnAdd').on('click', function () {
				  document.location.href = "app/index/video_add";  		
			  });
			  
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;	
				  document.location.href = "app/index/video_add?reqId="+anSelectedId;  			
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">  Video</div>

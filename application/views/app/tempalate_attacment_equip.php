...
$this->load->model('MasterPmsFile');
$reqId = $this->input->get('reqId');
if(empty($reqId)){
    $reqId=-1;
}
// echo $reqId;
$document_attacment = new MasterPmsFile();
$document_attacment->selectByParamsMonitoring(array("CAST(A.MASTER_PMS_FILE_ID AS VARCHAR)" => $reqId));


$document_attacment->firstRow();
$reqDocumentAttacmentId= $document_attacment->getField("MASTER_PMS_FILE_ID");
...
<link rel="stylesheet" href="css/gaya-multifile.css" type="text/css" />
  <!-- EASYUI 1.4.5 -->
    ...
    <?
    $aColumns = array("MASTER_PMS_FILE_ID","NAME","KETERANGAN","PATH","FILE","AKSI");
    ?>
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/master_pms_file_json/json?reqId=<?= $reqId ?>",
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Entry Document of Equipment</div>
            ...
            <div>
                 <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                     ...
                     <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i>Equipment File</h3>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input type="file" name="document[]" class="form-control" style="width: 90%">
                                            ...
                                            if(!empty($reqPath)){
                                            ?>
                                            <a onclick="openAdd('uploads/master_list_equip/<?= $reqId ?>/<?= $reqPath ?>');" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file"> <?= $reqPath ?> </span>
                                            <?
                                            }
                                            ?>
                                </div>
                    ...
                    <input type="hidden" name="reqMode" value="<?= $reqMode ?>" />
                     <input type="hidden" name="reqTipe" value="master_list_equip" />
...
<script type="text/javascript">
        ...
        function editing(id) {
           ...
           // console.log(elements[0]);
            window.location.href="app/loadUrl/app/tempalate_attacment_equip?reqId="+elements[0];
         ...
         function deleting(id) {
            ...
            $.get("web/master_pms_file_json/delete?reqId=" + elements[0], function(data) {
    ...
    <script type="text/javascript">
        function submitForm() {
            ...
            $('#ff').form('submit', {
                url: 'web/master_pms_file_json/add',
                onSubmit: function() {

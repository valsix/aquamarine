...
$this->load->model("MasterSuplay");
$personal_certificate= new MasterSuplay();
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master of Suplay </div>
            ...
            <div>
                 <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                     ...
                     <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master Suplay</h3>
                    </div>
                        ...
                        <?
                         ...
                         $personal_certificate->selectByParamsMonitoring(array());
                          while (  $personal_certificate->nextRow()) {
                             ...
                             $reqIds             = $personal_certificate->getField("MASTER_SUPLAY_ID");
                             $reqJenis           = $personal_certificate->getField("NAMA");
                             $reqDescription     = $personal_certificate->getField("KETERANGAN");
                        ?>  
                            <tr>
...
<script type="text/javascript">
      function submitForm() {
            $('#ff').form('submit', {
                url: 'web/master_suplay_json/add',
                onSubmit: function() {
                ...
                success: function(data) {
                    ...
                    //alert(data);
                    $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_suplay");
                }
            });
        }
        function hapus(id){
        deleteData('web/master_suplay_json/delete',id);
    }
        function clearForm() {
            $('#ff').form('clear');
        }
        ...
        function tambahPenyebab(id){
            window.location.href="app/loadUrl/app/tempalate_master_suplay?reqId="+id;

...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master of Alat </div>
            ...
            <div>
                 <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                     ...
                     <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master Alat</h3>
                    </div>
                        ...
                        <?
                         ...
                         $personal_certificate->selectByParamsMonitoring(array());
                          while (  $personal_certificate->nextRow()) {
                             ...
                             $reqIds             = $personal_certificate->getField("MASTER_ALAT_ID");
                             $reqJenis           = $personal_certificate->getField("NAMA");
                             $reqDescription     = $personal_certificate->getField("KETERANGAN");
                        ?>  
                            <tr>
      ...
      function submitForm() {
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    //alert(data);
                    $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_alat");
                }
            });
        }
        function hapus(id){
        deleteData('web/master_alat_json/delete',id);
    }
        function clearForm() {
            $('#ff').form('clear');
        }
        ...
        function tambahPenyebab(id){
            window.location.href="app/loadUrl/app/tempalate_master_alat?reqId="+id;

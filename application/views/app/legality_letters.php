...
"orderable": false
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/legality_letters_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/legality_letters_add";
        ...
        $('#btnDelete').on('click', function() {
            if (anSelectedData == "")
                return false;
            // deleteData("web/legality_letters_json/delete", anSelectedId);
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_legality_letters_pdf?<?= $add_str ?>'+add_str);
            // openAdd('report/index/report_cetak_project_cost_pdf?reqId=' + anSelectedId);
        });


        $('#btnImport').on('click', function() {
            openAdd("app/loadUrl/app/import_template_legality_letters");
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Legality Letter </div>
                ...
                <div class="panel-body" style="padding: 10px">
                    <form id="ffs" class="easyui-form form-horizontal" method="post" data-options="novalidate:true">
                        <table id="tablei" style="width: 100%;padding: 10px;margin:10px">
                            ...
                            <tr>
                                <td>Expired Date </td>
                                <td colspan="2"><input type="text" name="reqCariExpiredDateFrom" class="easyui-datebox " id="reqCariExpiredDateFrom" value="<?= $reqCariExpiredDateFrom ?>"> To <input type="text" name="reqCariExpiredDateTo" class="easyui-datebox " id="reqCariExpiredDateTo" value="<?= $reqCariExpiredDateTo ?>"> </td>

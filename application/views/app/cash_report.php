...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/cash_report_json/json?pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $('#btnDelete').on('click', function() {
            ...
            deleteData_for_table('web/cash_report_json/delete', anSelectedId, anIndex, 1);
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_cash_report_pdf?'+add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Cash Report</div>

...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/certificate_expired_json/json?reqCal=1",
            columnDefs: [{
                className: 'never',
                targets: [0,4]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            window.open('app/index/certificate_add?reqId='+anSelectedId); 
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Expired Certificate </div>

...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/customer_complain">Monitoring Document of Complain Customer</a> &rsaquo; Form Monitoring Document of Complain Customer
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Entry Document of Complaint Customer
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {
                                            ?>
                                              <a href="uploads/complaint_customer/<?= $reqId ?>/<?= $files_data[$i] ?>" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            else
                                            {
                                            ?>
                                              <a onclick="openAdd(`uploads/complaint_customer/<?= $reqId ?>/<?= $files_data[$i] ?>`);" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            ?>
                                        </td>
  ...
  var win = $.messager.progress({
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    $.messager.alertLink('Info', datas[1], 'info', "app/index/customer_complain_add?reqId=" + datas[0]);
                    }

...
if ($reqId == "") {
    ...
    $reqMode = "ubah";
    $statement = " AND A.EC_ID = " . $reqId;
    $type_of_service->selectByParamsMonitoring(array(), -1, -1, $statement);

    $type_of_service->firstRow();
    $reqId = $type_of_service->getField("EC_ID");
    $reqName = $type_of_service->getField("EC_NAME");
    $reqDescription = $type_of_service->getField("EC_DESCRIPTION");
}
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master Kategori Equip </div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master Of Kategori Equip </h3>
                    </div>
                ...
                <table style="width: 100%" id="tablei" class="table table-striped table-hover dt-responsive" style="background: white">
                    ...
                    <tbody id="tambahAttacment">
                        ...
                        while ($type_of_service->nextRow()) {
                            ...
                            $reqIds = $type_of_service->getField("EC_ID");
                            $reqJenis           = $type_of_service->getField("EC_NAME");
                            $reqDescription     = $type_of_service->getField("EC_DESCRIPTION");
                        ?>
                            <tr>
...
<script type="text/javascript">
    function submitForm() {
        $('#ff').form('submit', {
            url: 'web/equipment_kategori_json/add',
            onSubmit: function() {
            ...
            success: function(data) {
                ...
                //alert(data);
                $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_kategori_equip");
    ...
    function hapus(id){
        deleteData('web/equipment_kategori_json/delete',id);
    }

    function tambahPenyebab(id) {
        window.location.href = "app/loadUrl/app/tempalate_master_kategori_equip?reqId=" + id;

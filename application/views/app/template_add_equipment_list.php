...
<div class="col-md-12">
        ...
        <div class="konten-area">
            <div class="konten-inner">
                <div>
                     ...
                     <div class="row">
                        <div class="col-md-8">
                           <div class="form-group">
                            <label for="reqName" class="control-label col-md-2">Equipment Name</label>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <div class="col-md-11">
                                    ...
                                    <input type="hidden" value="" name="reqSoEquipId" id="reqSoEquipId">
                                                <input type="hidden" value="" name="reqEquipId" id="reqEquipId" class="easyui-validatebox textbox form-control" required>
                                     <input type="hidden" value="<?=$reqId?>" name="reqIds" id="reqIds">
                                        <input type="hidden" value="<?=$reqId?>"  id="reqId">
                                     <input type="text"  class="easyui-validatebox textbox form-control" id="reqName" name="reqName" value="<?= $reqContactPerson ?>" style=" width:100%" onclick="pilih_company()"/> 

                                            </td>
                                            <td style="width: 10%"> <button type="button" class="btn btn-default" > ... </button> </td>
                                        </tr>
                                    </table>
                    ...
                    <div class="form-group">
                        <label for="reqName" class="control-label col-md-2">Out Condition</label>
                        <div class="col-md-8">
                            <div class="form-group">
                                <div class="col-md-11">
                                     <input class="easyui-combobox form-control" style="width:100%" id="reqOutCondition" name="reqOutCondition" data-options="width:'90',editable:false, valueField:'id',textField:'text',url:'combo_json/equipmentStatus'" value="" />
                   ...
                   <div class="form-group">
                        <label for="reqName" class="control-label col-md-2">Condition</label>
                        <div class="col-md-8">
                            <div class="form-group">
                                <div class="col-md-11">
                                   <input class="easyui-combobox form-control" style="width:100%" id="reqCondition" name="reqCondition" data-options="width:'90',editable:false, valueField:'id',textField:'text',url:'combo_json/equipmentStatus'" value="" />
  ...
  border-radius: 25px;">
                            <img src="images/icon-user-login.png" style="height: 50%;width:100%;"></div>
                        </div>
                            </div>
                          </div>
...
<script type="text/javascript">
     function editing(id){
            ...
            $("#reqName").val(elements[6]);
            $("#reqItem").val(elements[7]);
            $("#reqQty").val(elements[10]);
            $("#reqOutCondition").combobox('setValue',elements[4]);
            $("#reqCondition").combobox('setValue',elements[5]);
            $("#reqRemark").val(elements[9]);
            $("#reqEquipId").val(elements[2]);
    ...
    function reseti(){
         ...
         $("#reqCondition").combobox('setValue','');
         $("#reqRemark").val('');
         $("#reqEquipId").val('');
    }

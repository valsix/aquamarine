...
$reqType = $_SESSION[$pg."reqType"];


 $this->load->model("Employment_contracts");
$offer = new Employment_contracts();
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/employment_contracts_json/json?pg=<?=$pg?>",
            "columnDefs": [ 
                {
                    className: 'never',
                    targets: [0, 6, 7]
...
"orderable": false
            ...
            "fnServerParams": function ( aoData ) {
                    ...
                    aoData.push( { "name": "reqType", "value": $("#reqType").combobox('getValue') } );
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/employment_contracts_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/employment_contracts_add";
        ...
        $('#btnDelete').on('click', function() {
            if (anSelectedData == "")
                return false;
            // deleteData("web/employment_contracts_json/delete", anSelectedId);
            deleteData_for_table('web/employment_contracts_json/delete', anSelectedId, anIndex, 2);
        });
        ...
        $('#btnPrint').on('click', function() {
            ...
            add_str += "&reqType="+$("#reqType").combobox('getValue');
            add_str += "&reqSearch="+$('.dataTables_filter input').val();
            openAdd('app/loadUrl/report/cetak_employment_contracts_pdf?'+add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Contracts</div>
                ...
                <div class="panel-body" style="padding: 10px">
                    <form id="ffs" class="easyui-form form-horizontal" method="post" data-options="novalidate:true">
                        <table id="tablei" style="width: 100%;padding: 10px;margin:10px">
                            ...
                            <tr>
                                <td>Type </td>
                                <td colspan="2"> <input class="easyui-combobox form-control" style="width:100%" name="reqType" id="reqType" data-options="width:'200', height: 36,editable:false, valueField:'id',textField:'text',url:'combo_json/comboTypeContact?reqMode=ALL'" value="<?= $reqType ?>" /></td>

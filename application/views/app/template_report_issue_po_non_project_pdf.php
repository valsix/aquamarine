...
//$html = file_get_contents($this->config->item('base_report') . "report/index/po_baru/?reqId=" . $reqId);
$html = file_get_contents($this->config->item('base_report') . "report/index/po_non_baru?reqId=" . $reqId);


$mpdf->WriteHTML($html,2);
$mpdf->AddPage();
$html = file_get_contents($this->config->item('base_report') . "report/index/template_report_issue_po_non_project2/?reqId=" . $reqId);

...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master Type Of Service </div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Type Of Service </h3>
                    </div>
                ...
                <table style="width: 100%" id="tablei" class="table table-striped table-hover dt-responsive" style="background: white">
                    ...
                    <tbody id="tambahAttacment">
                        ...
                        while ($type_of_service->nextRow()) {
                            ...
                            $reqIds = $type_of_service->getField("TYPE_OF_SERVICE_ID");
                            $reqJenis           = $type_of_service->getField("NAME");
                            $reqDescription     = $type_of_service->getField("DESCRIPTION");
                        ?>
                            <tr>
...
<script type="text/javascript">
    function submitForm() {
        $('#ff').form('submit', {
            url: 'web/type_of_service_json/add',
            onSubmit: function() {
            ...
            success: function(data) {
                ...
                //alert(data);
                $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_type_of_service");
            }
        });
    }

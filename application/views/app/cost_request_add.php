            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <label for="reqTanggal" class="control-label col-md-2">Cost Request No.</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input type="text" id="reqKode" class="easyui-validatebox form-control" name="reqKode" value="<?= $reqKode ?>" style=" width:100%" placeholder="Cost Request No"  />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    ...
                                    <input class="easyui-combobox form-control " style="width:100%" id="reqCostCode" name="reqCostCode" data-options="width:'350',editable:true, valueField:'id',textField:'text',url:'combo_json/combo_cost_code'" value="" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input id="reqDetailTanggal" class="easyui-datebox textbox form-control" name="reqDetailTanggal" value="" style=" width:100%" required />
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function editing(id) {
        ...
        $("#reqDetailTanggal").datebox('setValue', elements[5]);
        $("#reqEvidance").combobox('setValue', elements[6]);
        $("#reqAmount").val(elements[12]);
        $("#reqProject").val(elements[8]);
        $("#reqPaidTo").val(elements[9]);

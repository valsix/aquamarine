...
if ($reqId == "") {
    ...
    $reqMode = "ubah";
    $statement = " AND A.BANK_ID = " . $reqId;
    $bank->selectByParamsMonitoring(array(), -1, -1, $statement);

    $bank->firstRow();
    $reqId = $bank->getField("BANK_ID");
    $reqNama = $bank->getField("NAMA");
    $reqKodeRekening = $bank->getField("KODE_REKENING");
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master of Bank </div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master Bank</h3>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="reqPhone" class="control-label col-md-2">Kode Rekening</label>
                        <div class="col-md-8">
                            <div class="form-group">
                                <div class="col-md-11">
                                  <input type="text" class="easyui-validatebox textbox form-control" name="reqKodeRekening" id="reqKodeRekening" value="<?= $reqKodeRekening ?>" style=" width:100%" />
...
<script type="text/javascript">
    function submitForm() {
        $('#ff').form('submit', {
            ...
            success: function(data) {
                ...
                //alert(data);
                $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_bank");
            }
        });
    }
    ...
    function tambahPenyebab(id) {
        window.location.href = "app/loadUrl/app/tempalate_master_bank?reqId=" + id;

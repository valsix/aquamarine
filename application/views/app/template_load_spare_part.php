...
// );
$aColumns = array(
    "PMS_DETIL_ID", "ITEM NAME", "NO. SPARED PART", "COMPONENT", "TIME OF TEST INSPECTION", "CATEGORI COMPETEN PERSON", "LAST KALIBRATION", "NEXT CALIBRATION","CONDITION"
);
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/spare_part_json/json?reqCal=1",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            window.open('app/index/legality_letters'); 
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Component part </div>

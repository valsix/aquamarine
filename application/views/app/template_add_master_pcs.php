...
$so_team = new MasterPsc();

$aColumns = array("MASTER_PSC_ID","NAMA","KETERANGAN","AKSI" );
$reqId = $this->input->get("reqId");



    $so_team->selectByParamsMonitoring(array("CAST(MASTER_PSC_ID AS VARCHAR)" => $reqId));
    $so_team->firstRow();
    $reqId    =  $so_team->getField("MASTER_PSC_ID");
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/master_psc_json/json?reqModes=<?=$reqModes?>&reqId="+reqIds,
                ...
                <div>
                     <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                       <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Add Master PSC</h3>
                     </div>
       ...
       function deleting(id){
           var elements  = oTable.fnGetData(id);
                   var kata =  '<b>Detail </b><br>'+elements[2]+"  ";
                    var delele_link='web/master_psc_json/delete';

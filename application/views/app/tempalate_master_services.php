...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master Services </div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master Of Services </h3>
                    </div>
                ...
                <table style="width: 100%" id="tablei" class="table table-striped table-hover dt-responsive" style="background: white">
                    ...
                    <tbody id="tambahAttacment">
                        ...
                        while ($type_of_service->nextRow()) {
                            ...
                            $reqIds = $type_of_service->getField("SERVICES_ID");
...
<script type="text/javascript">
    function submitForm() {
        $('#ff').form('submit', {
            ...
            success: function(data) {
                ...
                //alert(data);
                $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_services");
            }
        });
    }
    ...
    function hapus(id){
        deleteData('web/services_json/delete',id);
    }

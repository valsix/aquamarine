...
$aColumns = array("PEGAWAI_ID", "NRP", "NAMA", "UNIT KERJA", "JABATAN", "LOGIN_TERAKHIR");
?>
...
<script type="text/javascript" language="javascript" class="init">	
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/pegawai_json/pantau_json",		
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">  Pantau Pengguna</div>

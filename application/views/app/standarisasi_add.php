...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/standarisasi">Monitoring Document of Standarisasi </a> &rsaquo; Form Monitoring Document of Standarisasi
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Entry Document of Standarisasi
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {
                                            ?>
                                              <a href="uploads/standarisasi/<?= $reqId ?>/<?= $files_data[$i] ?>" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            else
                                            {
                                            ?>
                                              <a onclick="openAdd(`uploads/standarisasi/<?= $reqId ?>/<?= $files_data[$i] ?>`);" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            ?>   
                                        </td>
                    ...
                    <input type="hidden" name="reqTipe" value="Standarisasi" />
        ...
        function submitForm() {
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    //alert(data);
                    $.messager.alertLink('Info', datas[1], 'info', "app/index/standarisasi_add?reqId=" + datas[0]);
                    }

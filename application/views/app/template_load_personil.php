...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/personil_json/json",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $('#btnEdit').on('click', function() {
            if (anSelectedData == "")
                return false;
            companyPlihan( anSelectedId,anSelectedName);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Serching Vessel</div>
    ...
    <script type="text/javascript">
        function companyPlihan(id,name){
             top.company_pilihans(id,name);
             top.closePopup();
        }

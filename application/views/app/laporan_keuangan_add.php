...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/laporan_keuangan">Monitoring Laporan Keuangan</a> &rsaquo; Form Laporan Keuangan
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Entry Document of Form
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {
                                            ?>
                                              <a href="uploads/laporan_keuangan/<?= $reqId ?>/<?= ($files_data[$i]) ?>" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            else
                                            {
                                            ?>
                                              <a onclick="openAdd(`uploads/laporan_keuangan/<?= $reqId ?>/<?= ($files_data[$i]) ?>`);" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            ?>   
                                        </td>
                    ...
                    <input type="hidden" name="reqTipe" value="laporan_keuangan" />
...
var win = $.messager.progress({
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    $.messager.alertLink('Info', datas[1], 'info', "app/index/laporan_keuangan_add?reqId=" + datas[0]);
                    }

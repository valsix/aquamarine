...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master Type Contract </div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Type Contract </h3>
                    </div>
                ...
                <table style="width: 100%" id="tablei" class="table table-striped table-hover dt-responsive" style="background: white">
                    ...
                    <tbody id="tambahAttacment">
                        <?
                         ...
                         $tender_type_upload = new TenderTypeUpload();
                        $tender_type_upload->selectByParamsMonitoring(array("TYPE" => $reqType));
...
<script type="text/javascript">
    function submitForm() {
        $('#ff').form('submit', {
            url: 'web/type_contract_json/add',
            onSubmit: function() {
            ...
            success: function(data) {
                ...
                //alert(data);
                $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_type_contract");
            }
        });
    }
    ...
    function hapus(id){
        deleteData('web/type_contract_json/delete',id);
    }

    function tambahPenyebab(id) {
        window.location.href = "app/loadUrl/app/tempalate_master_type_contract?reqId=" + id;

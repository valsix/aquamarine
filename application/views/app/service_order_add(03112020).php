...
<div class="col-md-12">
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input type="text" class="easyui-validatebox textbox form-control" name="reqNoOrder" id="reqNoOrder" value="<?= $reqNoOrder ?>" style=" width:100%" onclick="pilih_project()" readonly/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
    ...
    <script type="text/javascript">
        ...
        function addOffering(id, kode,date,location) {
            $("#reqIdReport").val(id);
            $("#reqNoOrder").val(kode);

...
$aColumns = array("COST_REQUEST_ID", "NO","NO COST REQUEST", "TANGGAL", "TOTAL", "KETERANGAN");
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/cost_request_json/json?pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0]
            },
...
"orderable": false
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/cost_request_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/cost_request_add";
        ...
        $('#btnDelete').on('click', function() {
            ...
            deleteData_for_table('web/cost_request_json/delete', anSelectedId, anIndex, 1);
        ...
        $('#btnMaster').on('click', function() {
            openAdd('app/loadUrl/app/tempalate_master_code');
        });
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_cost_request_pdf?'+ add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Cost Request</div>

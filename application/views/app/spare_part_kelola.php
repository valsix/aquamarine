                        ...
                        <tr>
                         ...
                         <tr>
                          ...
                          <tr>
                            ...
                            <td> <div class="form-group">
                                <label for="reqName" class="control-label col-md-2">Nama Equipment</label>
                                <div class="col-md-4">
                                    <div class="form-group">
                                    <div class="input-group" style="width: 100%;">
                                        ...
                                        ?>
                                         ...
                                         ?>
                                          <input type="text" class="form-control"  id="reqNamaAlat" name="reqNamaAlat" value="<?= $arrDataVal['nama_part']?$arrDataVal['nama_part']:$arrDataPart['nama_alat']; ?>" 
                                          style=" width:100%"
                                          >
                                        </div>

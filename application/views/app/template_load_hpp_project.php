...
$projecthppnew->selectByParamsMonitoring(array());
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Searching Hpp Project</div>
    ...
    <div class="konten-area">
         ...
         <table id="example2" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
            <thead>
                <tr>
                      <th width="2%">NO</th>
                      <th width="2%" style="display: none;">HPP ID</th>
                       <th width="5%">AKSI</th>
                    <th>HPP PROJECT NO</th>
                      <th>PROJECT</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td> <?=$total?> </td>
                        <td style="display: none;"> <?=$value['project_hpp_new_id']?> </td>
                        <td>

...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/kas_besar_json/json?pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0,4]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/kas_besar_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/kas_besar_add";
        ...
        $('#btnDelete').on('click', function() {
            ...
            deleteData_for_table('web/kas_besar_json/delete', anSelectedId, anIndex, 1);
            // deleteData("web/kas_besar_json/delete", anSelectedId);
        });
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_kas_besar_pdf?'+add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Kas Besar</div>

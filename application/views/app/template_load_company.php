...
$aColumns = array(
   "COMPANY_ID","CHECK", "NAME", "EMAIL", "CONTACT_PERSON", "TELP"
);
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/customer_json/lookup_json?reqEmail=not",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Tempalte Email</div>

    <!--<div class="judul-halaman-bawah">&nbsp;</div>-->
    <div class="konten-area">
         <div id="bluemenu" class="aksi-area">
            <span><a id="btnAdd" onclick="company_terpilih()"><i class="fa fa-fw fa-plus" aria-hidden="true"></i> Pilih</a></span>
                ...
                <tr>
                    ...
                    for ($i = 1; $i < count($aColumns); $i++) {
                        ...
                        if($i > 1)
                            $width = "45%";
                    ?>
                        <th style="<?=$width?>"><?= str_replace('_', ' ', $aColumns[$i])  ?></th>
                    <?php
    ...
    function company_terpilih(){
        ...
        if(kode != ''){
            top.company_pilihan(kode,<?=$reqId?>);
            top.closePopup();
        }

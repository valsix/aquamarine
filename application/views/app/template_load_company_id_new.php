...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/customer_json/combo_json?reqCheck=tidak",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
            "fnServerParams": function(aoData) {
                aoData.push( { "name": "reqKategori", "value": "<?=$reqKategori?>" } );
        ...
        $("#example tbody").click(function(event) {
            ...
            anSelectedEmail = element[6];
            anSelectedTelephone = element[4];
            anSelectedFaximile = element[5];
            anSelectedHp = element[8];
            anSelectedContact = element[7];
        });

...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		oTable = $('#example').dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "web/slider_json/json/?reqJenis=GAMBAR",
			columnDefs: [{
				className: 'never',
				targets: [0]
			}],
		...
		$('#btnAdd').on('click', function() {
			document.location.href = "app/index/gambar_add";
		});

		$('#btnEdit').on('click', function() {
			if (anSelectedData == "")
				return false;
			document.location.href = "app/index/gambar_add?reqId=" + anSelectedId;
...
<div class="col-md-12">
	...
	<div class="judul-halaman"> Gambar</div>

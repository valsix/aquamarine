...
$aColumns = array(
    "DOCUMENT_TENDER_ID","NO","CATEGORY","NAME","DESCRIPTION"
);

$categori = "dokument_tender";
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/dokument_tender_json/json?<?= $add_str ?>&pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0,2]
            },{
...
"orderable": false
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/tender_dok_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/tender_dok_add";
        ...
        $('#btnDelete').on('click', function() {
            ...
            deleteData_for_table('web/dokument_tender_json/delete', anSelectedId, anIndex, 2);
        });
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_hse_pdf?<?=$add_str?>'+add_str);
            // openAdd('report/index/report_cetak_project_cost_pdf?reqId=' + anSelectedId);
        });


        $('#btnImport').on('click', function() {
            openAdd("app/loadUrl/app/import_template_hse");
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">  Standart Dokumen Tender</div>

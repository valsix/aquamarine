...
$category_other = new CategoryOther();
...
if ($reqId == "") {
    ...
    $reqMode = "ubah";
    $statement = " AND A.CATEGORY_ID = " . $reqId;
    $category_other->selectByParamsMonitoring(array(), -1, -1, $statement);

    $category_other->firstRow();
    $reqId = $category_other->getField("CATEGORY_ID");
    $reqName = $category_other->getField("CATEGORY");
    $reqDescription = $category_other->getField("DESCRIPTION");
}
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master Format </div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Format </h3>
                    </div>
                ...
                <table style="width: 100%" id="tablei" class="table table-striped table-hover dt-responsive" style="background: white">
                    ...
                    <tbody id="tambahAttacment">
                        <?
                         ...
                         $category_other = new CategoryOther();
                        $category_other->selectByParamsMonitoring(array());
                        while ($category_other->nextRow()) {

                            $reqIds = $category_other->getField("CATEGORY_ID");
                            $reqJenis           = $category_other->getField("CATEGORY");
                            $reqDescription     = $category_other->getField("DESCRIPTION");
                        ?>
                            <tr>
...
<script type="text/javascript">
    function submitForm() {
        $('#ff').form('submit', {
            url: 'web/category_other_json/add',
            onSubmit: function() {
            ...
            success: function(data) {
                ...
                //alert(data);
                $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_format");
            }
        });
    }
    ...
    function hapus(id){
        deleteData('web/category_other_json/delete',id);
    }

    function tambahPenyebab(id) {
        window.location.href = "app/loadUrl/app/tempalate_master_format?reqId=" + id;

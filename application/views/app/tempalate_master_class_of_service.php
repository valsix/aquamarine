...
if ($reqId == "") {
    ...
    $reqMode = "ubah";
    $statement = " AND A.CLASS_OF_VESSEL_ID = " . $reqId;
    $class_of_vessel->selectByParamsMonitoring(array(), -1, -1, $statement);

    $class_of_vessel->firstRow();
    $reqId = $class_of_vessel->getField("CLASS_OF_VESSEL_ID");
    $reqName = $class_of_vessel->getField("NAME");
    $reqDescription = $class_of_vessel->getField("DESCRIPTION");
}
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master Class Of Vessel </div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Class of Vessel</h3>
                    </div>
                ...
                <table style="width: 100%" id="tablei" class="table table-striped table-hover dt-responsive" style="background: white">
                    ...
                    <tbody id="tambahAttacment">
                        <?
                         ...
                         $class_of_vessel = new ClassOfVessel();
                        $class_of_vessel->selectByParamsMonitoring(array());
                        while ($class_of_vessel->nextRow()) {

                            $reqIds = $class_of_vessel->getField("CLASS_OF_VESSEL_ID");
                            $reqJenis           = $class_of_vessel->getField("NAME");
                            $reqDescription     = $class_of_vessel->getField("DESCRIPTION");
                        ?>
                            <tr>
...
<script type="text/javascript">
    function submitForm() {
        $('#ff').form('submit', {
            url: 'web/class_of_vessel_json/add',
            onSubmit: function() {
            ...
            success: function(data) {
                ...
                //alert(data);
                $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_class_of_service");
            }
        });
    }
    ...
    function hapus(id){
        deleteData('web/class_of_vessel_json/delete',id);
    }

    function tambahPenyebab(id) {
        window.location.href = "app/loadUrl/app/tempalate_master_class_of_service?reqId=" + id;

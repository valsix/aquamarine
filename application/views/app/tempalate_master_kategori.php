...
if ($reqId == "") {
    ...
    $reqMode = "ubah";
    $statement = " AND A.KATEGORI_CASH_ID = " . $reqId;
    $type_of_service->selectByParamsMonitoring(array(), -1, -1, $statement);

    $type_of_service->firstRow();
    $reqId = $type_of_service->getField("KATEGORI_CASH_ID");
    $reqName = $type_of_service->getField("NAMA");
    $reqDescription = $type_of_service->getField("KET");
    $reqFormat = $type_of_service->getField("FLAG");
}
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master Kategori </div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i>Master Kategori </h3>
                    </div>
                    <div class="form-group">
                        ...
                        <label for="reqName" class="control-label col-md-2"> Format</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input class="easyui-combobox form-control" style="width:100%" name="reqFormat" data-options="width:'250',editable:false, valueField:'id',textField:'text',url:'combo_json/comboValueKategori',required:true" value="<?= $reqFormat ?>" />
                ...
                <table style="width: 100%" id="tablei" class="table table-striped table-hover dt-responsive" style="background: white">
                    ...
                    <tbody id="tambahAttacment">
                        ...
                        while ($type_of_service->nextRow()) {
                            ...
                            $reqIds = $type_of_service->getField("KATEGORI_CASH_ID");
                            $reqJenis           = $type_of_service->getField("NAMA");
                            $reqDescription     = $type_of_service->getField("KET");
                        ?>
                            <tr>

...
// );
$aColumns = array(
    "EQUIP_ID", "NO", "EQUIPMENT_ID", "CATEGORY", "EQ_NAME", "PART_EQUIP", "NO_SERIAL",
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/equipment_calibrated_json/prod_json?reqCal=1",
            columnDefs: [{
                className: 'never',
                targets: [0,15]
            }],
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Calibrated Equipment</div>

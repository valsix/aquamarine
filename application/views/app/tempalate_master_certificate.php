...
$personal_certificate= new Certificate();
...
$reqMode = "ubah";
$statement= " AND A.CERTIFICATE_ID = ".$reqId;
$personal_certificate->selectByParams(array(), -1,-1, $statement);
$personal_certificate->firstRow();
$reqId          = $personal_certificate->getField("CERTIFICATE_ID");
$reqCertificate = $personal_certificate->getField("CERTIFICATE");
$reqDescription = $personal_certificate->getField("DESCRIPTION");
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master of  Certificate </div>
            ...
            <div>
                 <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                     ...
                     <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master Certificate</h3>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input type="text" class="easyui-validatebox textbox form-control" name="reqCertificate" id="reqCertificate" value="<?= $reqCertificate ?>" style=" width:100%" />
                  ...
                  <?
                    ...
                    <tbody id="tambahAttacment">
                        <?
                         ...
                         $personal_certificate= new Certificate();
                         $personal_certificate->selectByParams(array());
                          while (  $personal_certificate->nextRow()) {
                            
                             $reqIds             = $personal_certificate->getField("CERTIFICATE_ID");
                             $reqJenis           = $personal_certificate->getField("CERTIFICATE");
                             $reqDescription     = $personal_certificate->getField("DESCRIPTION");
                        ?>  
                            <tr>
      ...
      function submitForm() {
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    //alert(data);
                    $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_certificate");
                }
            });
        }
        function hapus(id){
        deleteData('web/certificate_json/delete',id);
    }
        function clearForm() {
            $('#ff').form('clear');
        }
        ...
        function tambahPenyebab(id){
            window.location.href="app/loadUrl/app/tempalate_master_certificate?reqId="+id;

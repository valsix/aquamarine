...
"orderable": false
            ...
            "fnServerParams": function ( aoData ) {
                    ...
                    aoData.push( { "name": "reqCariPeriodeYear", "value": $("#reqCariPeriodeYear").val() } );
        ...
        $("#example tbody").click(function(event) {
         ...
         $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anSelectedId = element[0];
            document.location.href = "app/index/equipment_delivery_pengembalian?reqId="+anSelectedId;
...
<div class="col-md-12">
    ...
    <div class="konten-area">
        <div id="bluemenu" class="aksi-area">
            ...
            <span><a id="btnEdit"><i class="fa fa-fw fa-pencil" aria-hidden="true"></i> Pengembalian</a></span>

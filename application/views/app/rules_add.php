...
if ($reqId == "") {
    ...
    $reqMode = "ubah";
    $rules->selectByParams(array("DOCUMENT_ID" => $reqId));
    $rules->firstRow();

    $reqName = $rules->getField("NAME");
    $reqDescription = $rules->getField("DESCRIPTION");
    $reqPath = $rules->getField("PATH");
    $reqLastRevisi = $rules->getField("LAST_REVISI");
    $reqClassRules = $rules->getField("CLASS_RULES");
}
?>
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/rules"> Rules & Regulation</a> &rsaquo; Form Rules
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="reqClassRules" class="control-label col-md-2">Rules</label>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input class="easyui-combobox form-control" style="width:100%" name="reqClassRules" data-options="width:'200',editable:false, valueField:'id',textField:'text',url:'combo_json/comboValueClassOfVessel'" value="<?= $reqClassRules ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <textarea name="reqDescription" id="reqDescription" style="width:100%" required><?= $reqDescription; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {
                                            ?>
                                              <a href="uploads/rules/<?= $reqId ?>/<?= $files_data[$i] ?>" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $text ?> </span>
                                            <?
                                            }
                                            else
                                            {
                                            ?>
                                              <a onclick="openAdd(`uploads/rules/<?= $reqId ?>/<?= $files_data[$i] ?>`);" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $text ?> </span>
                                            <?
                                            }
                                            ?>
        ...
        function submitForm() {
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    $.messager.alertLink('Info', datas[1], 'info', "app/index/rules_add?reqId=" + datas[0]);
                    }

...
if ($reqId == "") {
    ...
    $reqVesselType         = $service_order->getField("NO_ORDER");
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input type="text" id="reqNoDelivery" class="easyui-validatebox form-control" name="reqNoDelivery" value="<?=$reqNoDelivery?>" style=" width:100%" placeholder="No Delivery"  onclick="open_service_order()" readonly />
                                </div>
                            </div>
                        </div>
                    </div>

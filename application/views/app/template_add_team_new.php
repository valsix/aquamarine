...
if($reqSoTeamId == ""){}
    ...
    $so_team->selectByParamsMonitoring(array("SO_TEAM_NEW_ID" => $reqSoTeamId));
    $so_team->firstRow();
    ...
    $reqTypeOfService = $so_team->getField("SERTIFIKAT_ID");
     $reqRemark  = $so_team->getField("REMARK");
}
$reqRemark = $reqRemark?$reqRemark:'CV and certificate are attached';
?>
<base href="<?= base_url(); ?>" />
...
<?
        ...
        {    
            ...
            $so_team = new SoTeamNew();
            $so_team->setField("SO_TEAM_NEW_ID",$reqSoTeamId);
            ...
            $so_team->setField("TOTAL_STANDBY",$reqStandByTotal);
             $so_team->setField("REMARK",$reqRemark);
              $so_team->setField("SERTIFIKAT_ID",ValToNullDB($reqTypeOfService));
            ...
            $file = new FileHandler();
             $FILE_DIR = "uploads/so_team_new/" . $reqSoTeamId . "/";
                makedirs($FILE_DIR);
        ...
        $so_team->updateLampiran();
            ...
            ?>
            <script type="text/javascript">
             window.location.href = "app/loadUrl/app/template_add_team_new?reqId=<?= $reqId ?>&reqSoTeamId=";   
            </script>
            <?
...
<div class="col-md-12">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                         ...
                         <label for="reqName" class="control-label col-md-2">Certificate</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input class="easyui-validatebox form-control" style="width:100%" id="reqRemark" name="reqRemark" value="<?=$reqRemark?>" />
                                </div>
                            </div>
                        </div>
                         ...
                         <div >
                             <table id="example" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> <?=$no?> </td>
                                        <td>    <a href="javascript:void(0)" class="btn btn-warning" onclick="klikRubah(<?=$value['so_team_new_id']?>)"><i class="fa fa-fw fa-pencil"></i></a>
                    <a href="javascript:void(0)" class="btn btn-danger" onclick="delData(<?=$value['so_team_new_id']?>)"><i class="fa fa-fw fa-trash"></i></a>  </td>
    ...
    <script type="text/javascript">
       ...
       function openPersonil(){
        ...
        window.location.href='app/loadUrl/app/template_add_team_new?reqId=<?=$reqId?>&reqSoTeamId='+id;
     }
     function delData(id){
        deleteData('web/so_team_new_json/delete_new',id);
     }

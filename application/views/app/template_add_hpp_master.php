...
if($reqSoTeamId == ""){}
    ...
    $so_team->selectByParamsMonitoringTeam(array("HPP_MASTER_ID" => $reqId));
    $so_team->firstRow();
    $reqId    =  $so_team->getField("HPP_MASTER_ID");
    $reqCode  = $so_team->getField("CODE");
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/hpp_master_json/json?reqModes=<?=$reqModes?>&reqId="+reqIds,
                ...
                <div>
                     <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                       <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Add Master Hpp</h3>
                     </div>
       ...
       function deleting(id){
           var elements  = oTable.fnGetData(id);
                   var kata =  '<b>Detail </b><br>'+elements[2]+"  ";
                    var delele_link='web/hpp_master_json/delete';

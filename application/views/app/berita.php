...
$aColumns = array("SLIDER_ID", "TANGGAL", "NOTIF", "JUDUL", "ISI PESAN");
?>
...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		oTable = $('#example').dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "web/slider_json/json_nopublish/?reqJenis=BERITA",
			columnDefs: [{
				className: 'never',
				targets: [0]
			}],
		...
		$('#btnAdd').on('click', function() {
			document.location.href = "app/index/berita_add";
		});

		$('#btnEdit').on('click', function() {
			if (anSelectedData == "")
				return false;
			document.location.href = "app/index/berita_add?reqId=" + anSelectedId;
...
<div class="col-md-12">
	...
	<div class="judul-halaman"> Kirim Pesan</div>

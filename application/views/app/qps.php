...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/qps_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/qps_add";
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_qps_pdf?<?=$add_str?>'+add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> QPS</div>
                ...
                <div class="panel-body" style="padding: 10px">
                    <form id="ffs" class="easyui-form form-horizontal" method="post" data-options="novalidate:true">
                        <table id="tablei" style="width: 100%;padding: 10px;margin:10px">
                            <tr>
                                <td>Name </td>
                                <td colspan="2"><input type="text" name="reqCariName" class="form-control" id="reqCariName" value=""></td>
                            ...
                            <tr>
                                <td>Format </td>
                                <td colspan="2"> <input class="easyui-combobox form-control" style="width:100%" id="reqJenis" name="reqJenis" data-options="width:'150',editable:false, valueField:'id',textField:'text',url:'combo_json/comboQmss'" value="<?= $reqJenis ?>" />
</td>
                                <td colspan="2">&nbsp;</td>
                            </tr>

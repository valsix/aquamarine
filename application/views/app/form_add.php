...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/form">Monitoring Document of Form</a> &rsaquo; Form Monitoring Document of Form
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="reqNama" class="control-label col-md-2">Form Name</label>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {
                                            ?>
                                              <a href="uploads/Form/<?= $reqId ?>/<?= ($files_data[$i]) ?>" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $text ?> </span>
                                            <?
                                            }
                                            else
                                            {
                                            ?>
                                              <a onclick="openAdd(`uploads/Form/<?= $reqId ?>/<?= ($files_data[$i]) ?>`);" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $text ?> </span>
                                            <?
                                            }
                                            ?>   
                                        </td>
                    ...
                    <input type="hidden" name="reqTipe" value="Form" />
...
var win = $.messager.progress({
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    $.messager.alertLink('Info', datas[1], 'info', "app/index/form_add?reqId=" + datas[0]);
                    }

...
$aColumns = array(
    "CASH_REPORT_ID", "TANGGAL", "DESKRIPSI","AMOUNT_IDR","AMOUNT_USD"
);
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/cash_saldo_json/json?pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/cash_saldo_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/cash_saldo_add";

        });

        $('#btnBank').on('click', function() {
            openAdd('app/loadUrl/app/tempalate_master_bank');
        });
        ...
        $('#btnDelete').on('click', function() {
            ...
            deleteData_for_table('web/cash_saldo_json/delete', anSelectedId, anIndex, 1);
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_cash_saldo_pdf?'+add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Saldo Cash</div>
    ...
    <div class="konten-area">
        <div id="bluemenu" class="aksi-area">
            ...
            <span><a id="btnBank"><i class="fa fa-fw fa-gavel " aria-hidden="true"></i> Master Bank </a></span>

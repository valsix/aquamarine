...
$aColumns = array("TENDER_ID","URUT", "PROJECT_NO","CLIENT_NAME", "PROJECT_NAME", "STATUS", "DATE ISSUED ANNOUNCEMENT", "REGISTER DATE & COLLECT DOCUMENT", 
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/tender_json/json?reqAnnouncement=Fail,Pass,On Progress,Complete&pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            if(anSelectedId == "")
                return false;
            document.location.href = "app/index/tender_project_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/tender_project_add";
        ...
        $('#btnPrint').on('click', function() {
            ...
            add_str += "&reqAnnouncement=Pass";
            add_str += "&reqJudul=FILE EXIST PROJECT";

            openAdd('app/loadUrl/report/cetak_tender_project_pdf?pg=<?=$pg?>&reqAnnouncement2=Pass,On Progress,Complete&'+add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> File Project</div>

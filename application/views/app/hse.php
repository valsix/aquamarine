...
"orderable": false
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/hse_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/hse_add";
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Monitoring Document of HSE</div>

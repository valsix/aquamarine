                           ...
                           <!--  <tr>
                             ...
                             <tr>
                                ...
                                <td >
                                    ...
                                    <input class="easyui-combobox form-control" style="width:100%" name="reqCariClass" id="reqCariClass" data-options="width:'200',editable:false, valueField:'id',textField:'text',url:'combo_json/comboValueClassOfVessel'" value="<?= $reqCariClass ?>" />
                                </td>
                                <td>Class Type</td>
                                <td>
                              ...
                              <tr>
                                ...
                                <td > </td>
                                <td>Location</td>
                                <td colspan="2"><input type="text" name="reqCariLokasi" class="easyui-textbox form-control" id="reqCariLokasi" value="<?= $reqCariLokasi ?>" style="width: 40%" data-options="height: 36"> </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td colspan="3"></td>

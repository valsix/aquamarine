...
<script type="text/javascript" language="javascript" class="init">	
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/slider_json/json/?reqJenis=SLIDER",		
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
				  document.location.href = "app/index/slider_add";  		
			  });
			  
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;	
				  document.location.href = "app/index/slider_add?reqId="+anSelectedId;  			
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">  Berita</div>

...
$aColumns = array(
    "VESSEL_ID", "COMPANY_ID", "NAME", "DIMENSION_L", "DIMENSION_B", "DIMENSION_D",
    "TYPE_VESSEL", "CLASS_VESSEL", "TYPE_SURVEY", "LOCATION_SURVEY", "CONTACT_PERSON",
    "Gross Tonnage", "IMO Number", "Port of Registry", "CURRENCY", "CURRENCY_VALUE", "AKSI"
);
    ...
    <div class="judul-halaman"> <a href="app/index/customer_list">Customer</a> &rsaquo; Form Customer List
        <a class="pull-right " href="javascript:void(0)" style="color: white;font-weight: bold;" onclick="goBack()"><i class="fa fa-arrow-circle-left fa lg"> </i><span> Back</span> </a>
         ...
         <a class="pull-right " href="javascript:void(0)" style="color: white;font-weight: bold;margin-right: 10px" onclick="classes()"><i class="fa fa-fw fa-gavel fa lg"> </i><span>  Master Class of Vessel</span> </a>
          ...
          <a class="pull-right " href="javascript:void(0)" style="color: white;font-weight: bold;margin-right: 10px" onclick="types()"><i class="fa fa-fw fa-gavel fa lg"> </i><span> Master Type of Service</span> </a>
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <label for="reqCp1Telp" class="control-label col-md-2">Phone</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        ...
                        <label for="reqCp2Telp" class="control-label col-md-2">Phone</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        ...
                        <label for="reqLa1Phone" class="control-label col-md-2">Phone</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <textarea name="reqLa1Address" id="reqLa1Address" class="form-control" style="width:100%;"><?= $reqLa1Address ?></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="reqLa1Cp1Phone" class="control-label col-md-2">Phone</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        ...
                        <label for="reqLa1Cp2Phone" class="control-label col-md-2">Phone</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        ...
                        <label for="reqLa2Telp" class="control-label col-md-2">Phone</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <textarea name="reqLa2Address" id="reqLa2Address" class="form-control" style="width:100%;"><?= $reqLa2Address ?></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="reqLa2Cp1Phone" class="control-label col-md-2">Phone</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        ...
                        <label for="reqLa2Cp2Phone" class="control-label col-md-2">Phone</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">

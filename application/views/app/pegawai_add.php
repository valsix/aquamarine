...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/pegawai">Anggota</a> &rsaquo; Koreksi Profil Anggota</div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input readonly type="text" id="reqNama" class="easyui-textbox textbox form-control" required name="reqNama" maxlength="100" value="<?= $reqNama ?>" data-options="required:true" style="width:100%" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input readonly type="text" id="reqNamaPanggilan" class="easyui-textbox textbox form-control" required name="reqNamaPanggilan" maxlength="100" value="<?= $reqNamaPanggilan ?>" data-options="required:true" style="width:100%" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="reqNrp" class="control-label col-md-2">No SEKAR</label>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input readonly type="text" id="reqSekar" class="easyui-textbox textbox form-control" required name="reqSekar" maxlength="100" value="<?= $pegawai->getField("NO_SEKAR") ?>" data-options="required:true" style="width:100%" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input type="text" id="reqNrp" class="easyui-textbox textbox form-control" required name="reqNrp" maxlength="100" value="<?= $reqNrp ?>" data-options="required:true" style="width:100%" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input type="text" id="reqNip" class="easyui-textbox textbox form-control" required name="reqNip" maxlength="100" value="<?= $reqNip ?>" data-options="required:true" style="width:100%" />
                                </div>
                            </div>
                        </div>
                    </div>

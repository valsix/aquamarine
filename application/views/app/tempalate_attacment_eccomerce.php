...
$document_attacment->selectByParamsMonitoring(array("A.DOCUMENT_ATTACMENT_ID" => $reqId));


$document_attacment->firstRow();
$reqDocumentAttacmentId= $document_attacment->getField("DOCUMENT_ATTACMENT_ID");
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/document_attacment_json/json?reqId=<?= $reqId ?>",
            ...
            <div>
                 <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="reqMode" value="<?= $reqMode ?>" />
                     <input type="hidden" name="reqTipe" value="eccommerce" />
...
<script type="text/javascript">
        ...
        function editing(id) {
           ...
           // console.log(elements[0]);
            window.location.href="app/loadUrl/app/tempalate_attacment_eccomerce?reqId="+elements[0];
         ...
         function deleting(id) {
            ...
            $.get("web/document_attacment_json/delete?reqId=" + elements[0], function(data) {
    ...
    <script type="text/javascript">
        function submitForm() {
            ...
            $('#ff').form('submit', {
                url: 'web/document_attacment_json/add',
                onSubmit: function() {
                ...
                success: function(data) {
                    var datas = data.split('-');
                     oTable.api().ajax.reload(null,false);
                        ...
                        clearForm();
                    //alert(data);
                    // $.messager.alertLink('Info', datas[1], 'info', "app/loadUrl/app/tempalate_attacment_eccomerce?reqId=" + datas[0]);
                }
            });
        }
        function clearForm(){

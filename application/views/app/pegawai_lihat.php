...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/pegawai">Anggota</a> &rsaquo; Profil Anggota</div>
            ...
            <div> 
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                   ...
                   <div style="position:absolute; right:0">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    ...
                                    required name="reqNrp" maxlength="100"  value="<?=$pegawai->getField("NO_SEKAR")?>"
                    ...
                    <!-- TANGGAL_LAHIR -->
                    <div class="form-group">
                        <label for="reqGolonganDarah" class="control-label col-md-2">Golongan Darah</label>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input readonly type="text" id="reqGolonganDarah" class="easyui-textbox textbox form-control"
                                    required name="reqGolonganDarah" maxlength="100"  value="<?=$reqGolonganDarah ?>"
                                    data-options="required:true" style="width:20%" />
                                </div>
                            </div>
                        </div>
                    </div>

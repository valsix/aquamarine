...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master of Type Qualification </div>
            ...
            <div>
                 <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                     ...
                     <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master Type Personal Certificate</h3>
                    </div>
                     <div class="form-group">
                        <label for="reqName" class="control-label col-md-2"> Certificate Name</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
...
<script type="text/javascript">
      function submitForm() {
            $('#ff').form('submit', {
                url: 'web/personal_certificate_json/add',
                onSubmit: function() {
                ...
                success: function(data) {
                    ...
                    //alert(data);
                    $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_personal");
                }
            });
        }
        function hapus(id){
        deleteData('web/personal_certificate_json/delete',id);
    }
        function clearForm() {
            $('#ff').form('clear');
        }

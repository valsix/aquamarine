...
$aColumns = array(
    ...
    "EQUIPMENT", "DATE_OF_SERVICE","CONTACT_PERSON","SCOPE_OF_WORK","SURVEYOR","OPERATOR"
);
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/service_order_pop_up_json/json?reqCheck=tidak",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anSelectedHp = element[10];
            //TAMBAHAN
            anSelectedVesselName = element[4];
            anSelectedVesselType = element[5];
            anSelectedSurveyor = element[6];
            anSelectedProject = element[2];
            anSelectedLocation = element[7];
            anSelectedCompany = element[3];
            anSelectedContact = element[13];
            anSelectedDateStart = element[9];
            anSelectedDateFinish = element[10];
            anSelectedScope = element[14];
            anSelectedSurveyorCost = element[15];
            anSelectedOperatorCost = element[16];
            addOWR(anSelectedId, anSelectedName,anSelectedVesselName,anSelectedVesselType,anSelectedSurveyor,anSelectedProject,anSelectedCompany,anSelectedLocation,anSelectedContact,anSelectedDateStart,anSelectedDateFinish,anSelectedScope,anSelectedSurveyorCost,anSelectedOperatorCost);
            ...
            // console.log(anSelectedVesselType);
        });
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Serching Operation Work Request</div>
    ...
    <script type="text/javascript">
        ...
        function addOWR(id, kode,name,type,surveyor,project,company,location,contact,datestart,datefinish,scope,sur,op) {
            top.addOWR(id, kode,name,type,surveyor,project,company,location,contact,datestart,datefinish,scope,sur,op);
            top.closePopup();
        }
    </script>

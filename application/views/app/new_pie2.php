...
require_once ($_SERVER['DOCUMENT_ROOT'].'/aquamarine-baru/libraries/jpgraph-4.3.4/src/jpgraph.php');
require_once ($_SERVER['DOCUMENT_ROOT'].'/aquamarine-baru/libraries/jpgraph-4.3.4/src/jpgraph_pie.php');

...
// );
$aColumns =array(
            "COMPANY_ID", "","URUT", "NAME", "CP1_NAME", "PHONE", "EMAIL", "ADDRESS", "FAX",
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/customer_json/json?reqCheck=tidak",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $("#example tbody").click(function(event) {
            ...
            anSelectedName = element[2];
            anSelectedAdress = element[6];
            anSelectedEmail = element[5];
            anSelectedTelephone = element[8];
            anSelectedFaximile = element[7];
            anSelectedHp = element[4];
            anSelectedContact = element[3];
        });
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Serching Company</div>
    ...
    <script type="text/javascript">
        ...
        function companyPlihan(id, name, contact, anSelectedAdress, anSelectedEmail, anSelectedTelephone, anSelectedFaximile, anSelectedHp) {
            parent.company_pilihans(id, name, contact, anSelectedAdress, anSelectedEmail, anSelectedTelephone, anSelectedFaximile, anSelectedHp);
            parent.closePopup();
        }
    </script>

...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		oTable = $('#example').dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "web/dokumen_json/json",
			columnDefs: [{
				className: 'never',
				targets: [0]
			}],
		...
		$('#btnAdd').on('click', function() {
			document.location.href = "app/index/dokumen_add";
		});

		$('#btnEdit').on('click', function() {
			if (anSelectedData == "")
				return false;
			document.location.href = "app/index/dokumen_add?reqId=" + anSelectedId;
		...
		$('#btnDelete').on('click', function() {
			...
			deleteData("web/dokumen_json/delete", anSelectedId);
		...
		$('#btnPublish').on('click', function() {
			...
			konfirmasiAksi(pesan, "web/dokumen_json/publish", anSelectedId + "&reqStatus=" + status);
...
<div class="col-md-12">
	...
	<div class="judul-halaman">Dokumen</div>

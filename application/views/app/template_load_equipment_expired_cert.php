...
$aColumns = array(
    "EQUIP_ID", "NO", "EQUIPMENT_ID", "CATEGORY", "EQ_NAME", "NO_SERIAL",
    "CERTIFICATE_EXPIRED_DATE", "CERTIFICATE_ISSUED_DATE", "CONDITION",
    "STORAGE", "PRICE", "REMARKS", "SERIAL_NUMBER", "QUANTITY", "ITEM", "PIC_PATH", "STATUS"
);
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/equipment_list_json/expired_json?<?= $add_str ?>",
            columnDefs: [{
                className: 'never',
                targets: [0,9,10,11,12,13,14,15,16]
            }],
            responsive: false,
            // "bStateSave": true,
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            window.open('app/index/equipment_add?reqId='+anSelectedId);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Equipment Certificate Expired </div>

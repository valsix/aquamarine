...
$aColumns = array(
    "DOCUMENT_ID", "CATEGORY", "NAME", "DESCRIPTION", "PATH", "LAST_REVISI", "EXPIRED_DATE", "EXP"
);

$categori = "Company Profile";
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/dokumen_json/dok_json?pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0, 1, 4, 5, 6, 7]
            }],
            ...
            "fnServerParams": function ( aoData ) {
                aoData.push( { "name": "reqKategori", "value": 'Company Profile' } );
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/company_profile_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/company_profile_add";
        ...
        $('#btnImport').on('click', function() {
            openAdd("app/loadUrl/app/import_template_company_profile");
        ...
        $('#btnPrint').on('click', function() {
              var add_str = "reqCariCompanyName="+$("#reqCariCompanyName").val() ;
                         add_str += "&reqCariDescription="+$("#reqCariDescription").val() ;
                          add_str += "&reqKategori=Company Profile" ;
                         
            openAdd('app/loadUrl/report/cetak_company_profile_pdf?'+add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Monitoring Document of Company Profile</div>

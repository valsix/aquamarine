...
$reqPeriod = $_SESSION[$pg."reqPeriod"];
?>
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/bussines_plan_json/json?pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0, 4, 5]
            }],
            ...
            "fnServerParams": function ( aoData ) {
                    ...
                    aoData.push( { "name": "reqPeriod", "value": $("#reqPeriod").combobox('getValue') } );
        ...
        $('#btnDelete').on('click', function() {
            ...
            deleteData_for_table('web/bussines_plan_json/delete', anSelectedId, anIndex, 2);
        });
        ...
        $('#btnPrint').on('click', function() {
                     ...
                     var add_str = "reqCariCompanyName="+$("#reqCariCompanyName").val();                
                      add_str += "&reqCariDescription="+$("#reqCariDescription").val();
                       add_str += "&reqPeriod="+$("#reqPeriod").combobox('getValue');
                      
            openAdd('app/loadUrl/report/cetak_bussines_plan_pdf?'+ add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Bussines Plan</div>
                    ...
                    <form id="ffs" class="easyui-form form-horizontal" method="post" data-options="novalidate:true">
                        <table id="tablei" style="width: 100%;padding: 10px;margin:10px">
                            ...
                            <tr>
                                <td>Period </td>
                                <td colspan="2">
                                    <input class="easyui-combobox form-control" style="width:100%" id="reqPeriod" name="reqPeriod" data-options="width:'200', height: 36,editable:false, valueField:'id',textField:'text',url:'combo_json/comboPeriod'" value="<?= $reqPeriod ?>" />
                                </td>

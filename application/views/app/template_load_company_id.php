...
// );
$aColumns =array(
            "COMPANY_ID", "","NO", "NAME", "CP1_NAME", "PHONE", "EMAIL", "ADDRESS", "FAX",
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        $("#example tbody").click(function(event) {
            ...
            anSelectedAdress = element[7];
            anSelectedEmail = element[6];
            anSelectedTelephone = element[9];
            anSelectedFaximile = element[8];
            anSelectedHp = element[5];
            anSelectedContact = element[4];
        });

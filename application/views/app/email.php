...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/email_json/json",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/email_add";
        ...
        $('#btnEdit').on('click', function() {
            if (anSelectedData == "")
                return false;
            document.location.href = "app/index/email_add?reqId=" + anSelectedId;
        ...
        $('#btnDelete').on('click', function() {
            if (anSelectedData == "")
                return false;
            deleteData("web/email_json/delete", anSelectedId);
        });
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Email</div>

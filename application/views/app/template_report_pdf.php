    ...
    <center>
        <div class="row">
            <div class="col">
                <table>
                    <tr>
                        <td style="width: 988px;" align="justify">Terima kasih atas kepercayaan COMPANY_NAME untuk mengunakan pekerjaan TYPE_OF_SURVEY di perusahaan kami, berdasarkan informasi by phone, dengan ini kami menawarkan harga sesuai detail di bawah ini: </td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <center>
        <div class="row">
            <div class="col">
                <table>
                    <tr>
                        <td style="width: 140px;">Scope Pekerjaan</td>
                        <td style="width: 25px;">:</td>
    ...
    <center>
        <div class="row">
            <div class="col">
                <table>
                    <tr>
                        <td style="width: 988px;" align="justify">Terima kasih atas perhatiannya, kami berharap dapat tetap terjalin kerjasama yang baik antara perusahaan kami dengan COMPANY_NAME mohon keputusannya dan untuk segera mengirim Working Order (WO).</td>
                    </tr>
                </table>
            </div>
        </div>

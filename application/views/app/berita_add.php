...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/berita">Kirim Pesan</a> &rsaquo; Kelola Pesan</div>   
    	...
    	<div class="konten-inner">
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="reqJenis" value="BERITA" />
            ...
            function submitForm(){
                ...
                $('#ff').form('submit',{
					...
					success:function(data){
						//alert(data);
						$.messager.alertLink('Info', data, 'info', "app/index/berita");	
					}
                });
            }
            function clearForm(){

...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/dokumen_other_json/json?<?= $add_str ?>&pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0, 1, 4, 5, 6]
            }],
            ...
            "fnServerParams": function ( aoData ) {
                    ...
                    aoData.push( { "name": "reqCariCategori", "value": $("#reqCariCategori").combobox('getValue') } );
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/order_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/order_add";
        ...
        $('#btnDelete').on('click', function() {
            ...
            deleteData_for_table('web/dokumen_other_json/delete', anSelectedId, anIndex, 2);
        });
        ...
        $('#btnPrint').on('click', function() {
                   var add_str = "reqCariCompanyName="+$("#reqCariCompanyName").val();                 
                      ...
                      add_str += "&reqCariCategori="+$("#reqCariCategori").combobox('getValue');
                     
            openAdd('app/loadUrl/report/cetak_others_pdf?'+add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Monitoring Document Other </div>
                ...
                <div class="panel-body" style="padding: 10px">
                    <form id="ffs" class="easyui-form form-horizontal" method="post" data-options="novalidate:true">
                        <table id="tablei" style="width: 100%;padding: 10px;margin:10px">
                            <tr>
                                <td>Name </td>
                                <td colspan="2"><input type="text" name="reqCariCompanyName" class="form-control" id="reqCariCompanyName" value="<?= $reqCariNoOrder ?>"></td>
                            ...
                            <tr>
                                <td>Categori </td>
                                <td colspan="2"><input class="easyui-combobox form-control" style="width:100%" name="reqCariCategori" id="reqCariCategori" data-options="width:'200',editable:false, valueField:'id',textField:'text',url:'combo_json/combo_categori_other'" value="<?= $reqCariCategori ?>" /></td>

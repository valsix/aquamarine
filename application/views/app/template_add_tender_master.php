...
$so_team = new MasterTender();

$aColumns = array("MASTER_TENDER_ID", "NO_PROJECT", "KETERANGAN","COMPANY_NAME","AKSI","COMPANY_ID" );
...
if($reqSoTeamId == ""){}
    ...
    $so_team->selectByParamsMonitoringTeam(array("MASTER_TENDER_ID" => $reqId));
    $so_team->firstRow();
    $reqId          =  $so_team->getField("MASTER_TENDER_ID");
    $reqCode        = $so_team->getField("NO_PROJECT");
    $reqCompanyId   = $so_team->getField("COMPANY_ID");
    $reqCompanyName = $so_team->getField("COMPANY_NAME");
}
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/master_tender_json/json?reqModes=<?=$reqModes?>&reqId="+reqIds,
...
<div class="col-md-12">
                ...
                <div>
                     <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                       <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Add Tender Master</h3>
                     </div>
                     <div class="form-group">
                        <label for="reqName" class="control-label col-md-2">No Project</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
       ...
       function deleting(id){
           var elements  = oTable.fnGetData(id);
                   var kata =  '<b>Detail </b><br>'+elements[2]+"  ";
                    var delele_link='web/master_tender_json/delete';
        ...
        function editing(id) {
            ...
            $("#reqCode").val(elements[1]);
             ...
             $("#reqCompanyId").val(elements[5]);
             $("#reqCompanyName").val(elements[3]);
    ...
    <script type="text/javascript">
        ...
        function openCompany() {
            openAdd('app/loadUrl/app/template_load_company_id_parent');
        }
    ...
    <script type="text/javascript">
         function company_pilihans(id,urut ,name, contact, reqAddress, reqEmail, reqTelephone, reqFaximile, reqHp) {
            $("#reqCompanyName").val(name);
            $("#reqCompanyId").val(id);
 ...
 <!-- EMODAL -->
    ...
    <script type="text/javascript">
        function submitForm() {
        $('#ff').form('submit', {
            url: 'web/master_tender_json/add',
            onSubmit: function() {

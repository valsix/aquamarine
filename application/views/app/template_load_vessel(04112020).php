...
$vessel = new Vessel();
$vessel->selectByParamsMonitoring(array("A.COMPANY_ID" => $reqCompanyId,"A.VESSEL_ID"=>$reqId));
$vessel->firstRow();
$reqId        = $vessel->getField("VESSEL_ID");
    ...
    <div class="konten-area">
       ...
       <div class="konten-area">
                    ...
                    <div class="form-group">
                        <div class="col-md-11">
                           <div class="col-xs-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="reqDimensionL" id="reqDimensionL" value="<?=currencyToPage3($reqDimensionL)?>" onchange="numberWithCommas('reqDimensionL')" onkeyup="numberWithCommas('reqDimensionL')"
                        ...
                        <div class="col-xs-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control"  id="reqDimensionB" name="reqDimensionB" value="<?=currencyToPage3($reqDimensionB)?>" onchange="numberWithCommas('reqDimensionB')" onkeyup="numberWithCommas('reqDimensionB')"
                        ...
                        <div class="col-xs-4">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control"  id="reqDimensionD" name="reqDimensionD" value="<?=currencyToPage3($reqDimensionD)?>" ononchange="numberWithCommas('reqDimensionD')" onkeyup="numberWithCommas('reqDimensionD')"
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label for="reqLa2Cp2" class="control-label col-md-2">Type of Survey</label>
            <div class="col-md-4">
                <div class="form-group">
                    <div class="col-md-11">
                         <input class="easyui-combobox form-control" style="width:100%" name="reqVasselType_survey" data-options="width:'190',editable:false, valueField:'id',textField:'text',url:'combo_json/comboValueClassOfSurvey'" value="<?= $reqTypeSurvey ?>" />
                    </div>
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <label for="reqLa2Cp2Phone" class="control-label col-md-2">Gross Tonnage</label>
            <div class="col-md-4">
                <div class="form-group">
                    <div class="col-md-11">
                         <input name="reqValueSurvey" id="reqValueSurvey" type="text" class="easyui-validatebox textbox form-control" value="<?= currencyToPage2($reqCurrencyValue) ?>" style="width:40%" 

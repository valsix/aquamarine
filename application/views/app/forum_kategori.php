...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		...
		oTable = $('#example').dataTable({
			...
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "web/forum_kategori_json/json",
			columnDefs: [{
				className: 'never',
				targets: [0]
			}],
		...
		$('#btnAdd').on('click', function() {
			document.location.href = "app/index/forum_kategori_add";
		});

		$('#btnEdit').on('click', function() {
			if (anSelectedData == "")
				return false;
			document.location.href = "app/index/forum_kategori_add?reqId=" + anSelectedId;
		...
		$('#btnDelete').on('click', function() {
			...
			deleteData("web/forum_kategori_json/delete", anSelectedId);
...
<div class="col-md-12">
	...
	<div class="judul-halaman"> Forum Kategori</div>

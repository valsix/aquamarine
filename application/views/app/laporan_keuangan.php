...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/laporan_keuangan_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/laporan_keuangan_add";
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_laporan_keuangan_pdf?<?=$add_str?>'+ add_str);
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> Monitoring Laporan Keuangan</div>

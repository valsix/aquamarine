...
$aColumns = array(
    "DOCUMENT_ID", "CATEGORY", "NAME OF PROCEDURE", "DESCRIPTION", "PATH", "EXPIRED_DATE"
);
$categori = "Work Procedures";
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/document_json/json?<?= $add_str ?>",
            columnDefs: [{
                className: 'never',
                targets: [0, 1, 4, 5]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/work_procedures_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/work_procedures_add";
        });
        ...
        $('#btnDelete').on('click', function() {
            if (anSelectedData == "")
                return false;
            // deleteData("web/work_procedures_json/delete", anSelectedId);
            deleteData_for_table('web/document_json/delete', anSelectedId, anIndex, 2);
        });
        ...
        $('#btnPrint').on('click', function() {
            ...
            openAdd('app/loadUrl/report/cetak_work_procedures_pdf?<?=$add_str?>'+add_str);
            // openAdd('report/index/report_cetak_project_cost_pdf?reqId=' + anSelectedId);
        });

        $('#btnImport').on('click', function() {
            openAdd("app/loadUrl/app/import_template_work_procedures");
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> WORK PROCEDURES LIST</div>
                ...
                <div class="panel-body" style="padding: 10px">
                    <form id="ffs" class="easyui-form form-horizontal" method="post" data-options="novalidate:true">
                        <table id="tablei" style="width: 100%;padding: 10px;margin:10px">
                            <tr>
                                <td>Name </td>
                                <td colspan="2"><input type="text" name="reqCariCompanyName" class="form-control" id="reqCariCompanyName" value=""></td>

...
//$html = file_get_contents($this->config->item('base_report') . "report/index/template_report_issue_po/?reqId=" . $reqId);
$html = file_get_contents($this->config->item('base_report') . "report/index/po_baru_news/?reqId=" . $reqId);

$mpdf->WriteHTML($html, 2);
$mpdf->AddPage();
$html = file_get_contents($this->config->item('base_report') . "report/index/template_report_issue_po2/?reqId=" . $reqId);

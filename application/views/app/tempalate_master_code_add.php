...
if ($reqId == "") {
    ...
    // $reqMode = "ubah";
    $statement = " AND CAST(A.COST_CODE_ID AS VARCHAR) = '" . $reqId."'";
    $cost_code->selectByParamsMonitoring(array(), -1, -1, $statement);

    $cost_code->firstRow();
    $reqId = $cost_code->getField("COST_CODE_ID");
    $reqParentId = $cost_code->getField("PARENT_ID");
    $reqNama = $cost_code->getField("NAMA");
    $reqCode = $cost_code->getField("KODE");
...
$cost_code2->selectByParamsMonitoring(array("CAST(A.COST_CODE_ID AS VARCHAR)"=>$reqParentId));
$cost_code2->firstRow();
$reqParentId = $cost_code2->getField("KODE");
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master of Cost Code </div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master Cost Code Add</h3>
                    </div>
                    ...
                    ?>
                     <div class="form-group">
                        <label for="reqPhone" class="control-label col-md-2">Parent Code</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                 <input class="easyui-combobox form-control " style="width:100%" id="reqParentId" name="reqParentId" data-options="width:'350',editable:true, valueField:'id',textField:'text',url:'combo_json/combo_cost_code'" value="<?=$reqParentId?>" />
                    ...
                    ?>
                     ...
                     <div class="form-group">
                        <label for="reqPhone" class="control-label col-md-2">Cost Code</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
...
<script type="text/javascript">
    function submitForm() {
        $('#ff').form('submit', {
            ...
            success: function(data) {
                ...
                //alert(data);
                // $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_code_add?reqId="+datas[0]);
                parent.reloads();
            }
        });
    }
    ...
    function tambahPenyebab(id) {
        window.location.href = "app/loadUrl/app/tempalate_master_code_add?reqId=" + id;

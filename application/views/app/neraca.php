...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/neraca_add";
        ...
        $('#btnEdit').on('click', function() {
            if (anSelectedData == "")
                return false;
            document.location.href = "app/index/neraca_add?reqId=" + anSelectedId;
        ...
        $('#btnDelete').on('click', function() {
            ...
            deleteData("web/neraca_json/delete", anSelectedId);

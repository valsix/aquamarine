...
if ($reqId == "") {
    ...
    $reqMode = "ubah";
    $statement = " AND A.SATUAN_ID = " . $reqId;
    $satuan->selectByParamsMonitoring(array(), -1, -1, $statement);

    $satuan->firstRow();
    $reqId = $satuan->getField("SATUAN_ID");
    $reqName = $satuan->getField("NAME");
    $reqDescription = $satuan->getField("DESCRIPTION");
}
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master Type Of Satuan </div>
            ...
            <div>
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master Of Satuan </h3>
                    </div>
                ...
                <table style="width: 100%" id="tablei" class="table table-striped table-hover dt-responsive" style="background: white">
                    ...
                    <tbody id="tambahAttacment">
                        ...
                        while ($satuan->nextRow()) {
                            ...
                            $reqIds = $satuan->getField("SATUAN_ID");
                            $reqJenis           = $satuan->getField("NAME");
                            $reqDescription     = $satuan->getField("DESCRIPTION");
                        ?>
                            <tr>
...
<script type="text/javascript">
    function submitForm() {
        $('#ff').form('submit', {
            ...
            success: function(data) {
                ...
                //alert(data);
                $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_satuan");
            }
        });
    }
    ...
    function hapus(id){
        deleteData('web/satuan_json/delete',id);
    }

    function tambahPenyebab(id) {
        window.location.href = "app/loadUrl/app/tempalate_master_satuan?reqId=" + id;

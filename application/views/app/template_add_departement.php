...
$so_team = new Departement();

$aColumns = array("DEPARTEMENT_ID", "NAMA", "KETERANGAN","AKSI" );
...
if($reqId == ""){}
    ...
    $so_team->selectByParamsMonitoringTeam(array("CAST(DEPARTEMENT_ID AS VARCHAR)" => $reqId));
    $so_team->firstRow();
    $reqId    =  $so_team->getField("DEPARTEMENT_ID");
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/departement_json/json?reqModes=<?=$reqModes?>&reqId="+reqIds,
                ...
                <div>
                     <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                       <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Add Master Departement</h3>
                     </div>
       ...
       function deleting(id){
           var elements  = oTable.fnGetData(id);
                   var kata =  '<b>Detail </b><br>'+elements[2]+"  ";
                    var delele_link='web/departement_json/delete';

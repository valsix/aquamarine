...
// );
$aColumns = array(
    "OFFER_REVISI_ID","REVISI","TANGGAL","REASON","AKSI"
);
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/offer_json/revisi_json?reqId=<?=$reqId?>",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            window.open('app/index/offer_add?reqId=<?=$reqId?>&reqRevId='+anSelectedId); 
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Offer Revisi</div>
    ...
    <script type="text/javascript">
        ...
        function deleting(id) {
            deleteData("web/offer_json/deleteRevisi", id);
        }
        function editing(id,nom) {
            window.open('app/index/offer_add?reqId=<?=$reqId?>&reqRevId='+id+"&reqNom="+nom); 
        }
    </script>

...
$so_team = new MasterReason();

$aColumns = array("MASTER_REASON_ID", "NAMA", "KETERANGAN","AKSI" );
...
if($reqSoTeamId == ""){}
    ...
    $so_team->selectByParamsMonitoringTeam(array("MASTER_REASON_ID" => $reqId));
    $so_team->firstRow();
    $reqId    =  $so_team->getField("MASTER_REASON_ID");
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/master_reason_json/json?reqModes=<?=$reqModes?>&reqId="+reqIds,
...
<div class="col-md-12">
                ...
                <div>
                     <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                       <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Add Master Reason</h3>
                     </div>
       ...
       function deleting(id){
           var elements  = oTable.fnGetData(id);
                   var kata =  '<b>Detail </b><br>'+elements[2]+"  ";
                    var delele_link='web/master_reason_json/delete';
 ...
 <!-- EMODAL -->
    ...
    <script type="text/javascript">
        function submitForm() {
        $('#ff').form('submit', {
            url: 'web/master_reason_json/add',
            onSubmit: function() {

...
$so_team = new MasterTenerMenus();

$aColumns = array("MASTER_TENDER_MENUS_ID","NAMA","ALIAS","COLOR","COLOR2","URUTAN","AKSI" );
$reqId = $this->input->get("reqId");



    $so_team->selectByParamsMonitoring(array("CAST(MASTER_TENDER_MENUS_ID AS VARCHAR)" => $reqId));
    $so_team->firstRow();
    $reqId    =  $so_team->getField("MASTER_TENDER_MENUS_ID");
    $reqNama= $so_team->getField("NAMA");
    $reqKeterangan= $so_team->getField("ALIAS");
    $reqColor= $so_team->getField("COLOR");
    $reqColor2= $so_team->getField("COLOR2");
    $reqUrutan= $so_team->getField("URUTAN");
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/master_tener_menus_json/json?reqModes=<?=$reqModes?>&reqId="+reqIds,
...
<div class="col-md-12">
                ...
                <div>
                     <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                       <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Add Master Menus Tender </h3>
                     </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input class="easyui-validatebox form-control" style="width:100%" id="reqCode" name="reqCode" value="<?=$reqNama?>" />
                        ...
                        <label for="reqName" class="control-label col-md-2">Urutan</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input class="easyui-validatebox form-control" onkeypress='validate(event)' style="width:20%" id="reqUrutan" name="reqUrutan" value="<?=$reqUrutan?>" required />
                    ...
                    <div class="form-group">
                        <label for="reqName" class="control-label col-md-2">Warna Di Atas 50</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input type="color" name="reqColor" id="reqColor" class=" form-control" style="width: 50%;" value="<?=$reqColor?>">
                                    
                                </div>
                            </div>
                        </div>
                        <label for="reqName" class="control-label col-md-2">Warna Di Bawah 50</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                                    
                                    <input type="color" name="reqColor2" id="reqColor2" class=" form-control" style="width: 50%;" value="<?=$reqColor2?>">
       ...
       function deleting(id){
           var elements  = oTable.fnGetData(id);
                   var kata =  '<b>Detail </b><br>'+elements[2]+"  ";
                    var delele_link='web/master_tener_menus_json/delete';
        ...
        function editing(id) {
            ...
            $("#reqCode").val(elements[1]);
             $("#reqKeterangan").val(elements[2]);
              $("#reqColor").val(elements[3]);
              $("#reqColor2").val(elements[4]);
              $("#reqUrutan").val(elements[5]);
 ...
 <!-- EMODAL -->
    ...
    <script type="text/javascript">
        function submitForm() {
        $('#ff').form('submit', {
            url: 'web/master_tener_menus_json/add',
            onSubmit: function() {
                return $(this).form('enableValidation').form('validate');
            },
            success: function(data) {
                var datas = data.split('-');
                show_toast('info','Success  row',datas[1]); 
                if(datas[0]=='OK'){

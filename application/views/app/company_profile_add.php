...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/company_profile">Monitoring Document Of Company Profile</a> &rsaquo; Form Monitoring Document Of Company Profile
        ...
        <a class="pull-right " href="javascript:void(0)" style="color: white;font-weight: bold;margin-right: 10px" onclick="send_email()"><i class="fa fa-envelope"> </i><span> Send As Email</span> </a>
    </div>
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Entry Document of Company Profile
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <textarea name="reqKeterangan" style="width:100%; height:200px"><?= $reqDescription ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {
                                            ?>
                                              <a href="uploads/company_profile/<?= $reqId ?>/<?= $files_data[$i] ?>" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            else
                                            {
                                            ?>
                                              <a onclick="openAdd(`uploads/company_profile/<?= $reqId ?>/<?= $files_data[$i] ?>`);" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $files_data[$i] ?> </span>
                                            <?
                                            }
                                            ?>
                                        </td>
                    ...
                    <input type="hidden" name="reqTipe" value="Company Profile" />
           ...
           var win = $.messager.progress({
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    $.messager.alertLink('Info', datas[1], 'info', "app/index/company_profile_add?reqId=" + datas[0]);
                    }
    ...
    <script type="text/javascript">
        function send_email() {
            var reqId ="<?=$reqId?>";
            if(reqId==''){
                $.messager.alert('Info', "Please Compate company profile", 'info');
            }
            openAdd('app/loadUrl/app/tempalate_company_send_mail?reqId=<?=$reqId?>');
        }
    </script>

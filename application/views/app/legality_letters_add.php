...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/legality_letters">Legality Letters</a> &rsaquo; Form Legality Letters
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Entry Document of Legality Letters
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {
                                            ?>
                                              <a href="uploads/legality_letters/<?= $reqId ?>/<?= $files_data[$i] ?>" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $text ?> </span>
                                            <?
                                            }
                                            else
                                            {
                                            ?>
                                              <a onclick="openAdd(`uploads/legality_letters/<?= $reqId ?>/<?= $files_data[$i] ?>`);" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file" id="namaFile<?=($i+1)?>"> <?= $text ?> </span>
                                            <?
                                            }
                                            ?>
                                        </td>
                    ...
                    <input type="hidden" name="reqTipe" value="Legality Letters" />
        ...
        function submitForm() {
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    $.messager.alertLink('Info', datas[1], 'info', "app/index/legality_letters_add?reqId=" + datas[0]);
                    }

...
<div class="col-md-12">
        ...
        <div class="konten-inner">
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                  <a href="uploads/template/template.xls" target="_blank" class=""> Download  </a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="reqName" class="control-label col-md-2">Kategori</label>
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-11">
                                    <input class="easyui-combobox form-control" style="width:100%" name="reqKategori" id="reqKategori"
                                           data-options="width:'350',editable:false, valueField:'id',textField:'text',url:'combo_json/comboKategori'"    
                                         >
                                </div>
                            </div>
                        </div>
    ...
    <script>
        function submitForm() {
            $('#ff').form('submit', {
                url: 'web/customer_json/importExcel',
                onSubmit: function() {

...
$aColumns = array("ISSUE_PO_ID","NO.", "PO NO.", "DATE PO", "COMPANY_OF NAME", "CONTACT", "DESCRIPTION", "TOTAL", "STATUS", "DOC_LAMPIRAN", "FINANCE", "ADDRESS", "EMAIL", "TELP", "FAX", "HP", "BUYER_ID", "OTHER", "PPN", "PPN_PERCENT");
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "sAjaxSource": "web/issue_po_non_project_json/json?pg=<?=$pg?>",
            columnDefs: [{
                className: 'never',
                targets: [0,9,10,14,15,16,17,18,19]
            },
            {
"targets": 1,
"orderable": false
        ...
        $('#example tbody').on('dblclick', 'tr', function() {
            ...
            anIndex = anSelected[0];
            anSelectedId = element[0];
            document.location.href = "app/index/issue_po_non_project_add?reqId=" + anSelectedId;
        ...
        $('#btnAdd').on('click', function() {
            document.location.href = "app/index/issue_po_non_project_add";
        });
        ...
        $('#btnDelete').on('click', function() {
            ...
            deleteData_for_table('web/issue_po_non_project_json/delete', anSelectedId, anIndex, 2);
        });
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> ISSUE PO NON PROJECT</div>
                    ...
                    <form id="ffs" class="easyui-form form-horizontal" method="post" data-options="novalidate:true">
                        <table id="tablei" style="width: 100%;padding: 10px;margin:10px">
                            ...
                            <tr>
                             ...
                             <tr>
                                <td>Periode  </td>
                                <td> <input class="easyui-combobox form-control" placeholder="Date" style="width:190px" id="reqBulan" name="ComboBulanId" data-options="editable:false,height: 34, valueField:'id',textField:'text',url:'combo_json/ComboBulan'" value="<?= $reqBulan ?>" /> /

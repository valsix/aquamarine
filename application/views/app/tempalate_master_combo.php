...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master  </div>
            ...
            <div>
                 <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                     ...
                     <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master </h3>
                    </div>
                  ...
                  <?
                    ...
                    <tbody id="tambahAttacment">
                        <?
                         ...
                         $personal_certificate= new MasterCombo();
                         $personal_certificate->selectByParamsMonitoring(array('A.MODUL'=>$reqModul));
                         // $personal_certificate->selectByParamsMonitoring(array());
                          while (  $personal_certificate->nextRow()) {
                            
                             $reqIds             = $personal_certificate->getField("MASTER_COMBO_ID");
                             $reqJenis           = $personal_certificate->getField("NAMA");
                             $reqDescription     = $personal_certificate->getField("KETERANGAN");
                        ?>  
                            <tr>
      ...
      function submitForm() {
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    //alert(data);
                    $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_combo?reqModul=<?=$reqModul?>");
                }
            });
        }
        function hapus(id){

...
$aColumns = array(
    "DOCUMENT_ID","NO", "NO_REPORT", "NAME", "NAME_OF_VESSEL", "TYPE_OF_VESSEL", "SCOPE_OF_WORK", 
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function() {
        ...
        oTable = $('#example').dataTable({
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "web/report_json/json?reqCheck=tidak",
            columnDefs: [{
                className: 'never',
                targets: [0]
            }],
        ...
        $("#example tbody").click(function(event) {
            ...
            anSelectedName = element[2];
             anSelectedAdress = element[3];
              anSelectedEmail = element[8];
              anSelectedTelephone = element[7];
              anSelectedFaximile = element[9];
              anSelectedHp = element[11];
            anSelectedContact = element[8];
...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Serching Report</div>

...
<div class="col-md-12">
    ...
    <div class="judul-halaman">Master Cabang </div>
            ...
            <div>
                 <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                     ...
                     <div class="page-header">
                        <h3><i class="fa fa-file-text fa-lg"></i> Master Cabang</h3>
                    </div>
                        ...
                        <?
                         ...
                         $personal_certificate->selectByParamsMonitoring(array());
                          while (  $personal_certificate->nextRow()) {
                             ...
                             $reqIds             = $personal_certificate->getField("CABANG_ID");
                             $reqKode           = $personal_certificate->getField("KODE");
                             $reqJenis           = $personal_certificate->getField("NAMA");
                             $reqDescription     = $personal_certificate->getField("DESCRIPTION");
                        ?>  
      ...
      function submitForm() {
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    //alert(data);
                    $.messager.alertLink('Info', data, 'info', "app/loadUrl/app/tempalate_master_personal_cabang");
                }
            });
        }
        function hapus(id){
        deleteData('web/cabang_json/delete',id);
    }
        function clearForm() {
            $('#ff').form('clear');
        }
        ...
        function tambahPenyebab(id){
            window.location.href="app/loadUrl/app/tempalate_master_personal_cabang?reqId="+id;

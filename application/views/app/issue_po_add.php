...
if ($reqId == "") {
    ...
    $reqDiskonPercent = $issue_po->getField("DISKON_PERCENT");
     $reqMaker = $issue_po->getField("MASTER_PROJECT_ID");
      
      $reqNamaProject =  $issue_po->getField("NAMA_PROJECT");
...
<div class="col-md-12">
    ...
    <div class="judul-halaman"> <a href="app/index/issue_po">Puchase Order </a> &rsaquo;Puchase Order add
        ...
        <a class="pull-right " href="javascript:void(0)" style="color: white;font-weight: bold;margin-right: 10px" onclick="cetakPdf()"><i class="fa fa-file-pdf-o "> </i><span> Print</span> </a>
         <a class="pull-right " href="javascript:void(0)" style="color: white;font-weight: bold;margin-right: 10px" onclick="openAdd('app/loadUrl/app/tempalate_master_lampiran?reqModul=SO_PO&reqId=<?=$reqId?>')"><i class="fa fa-file "> </i><span> Lampiran</span> </a>
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="reqMaker" class="control-label col-md-2">Project Code</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                 <div class="col-md-11">
                    ...
                    <div class="form-group">
                        <label for="reqInvoiceNumber" class="control-label col-md-2">Type Order</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        <label for="reqInvoiceNumber" class="control-label col-md-2">Order No.</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                        ...
                        <label for="reqTelephone" class="control-label col-md-2">Date Order</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="reqInvoiceNumber" class="control-label col-md-2">Doc. Attachment</label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <label for="reqPpn" class="control-label col-md-2">Discount <input type="checkbox" <?= $checksDiskon ?> name="reqDiskon" id="reqDiskon" onchange="getPPn()" onkeyup="getPPn()" value="1" /> </label>
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="col-md-11">
                    ...
                    <div class="form-group">
                        <div class="col-md-7">
                            <label for="reqCompanyName" class="control-label col-md-2">Company</label>
                            <div class="col-md-10">
                                <div class="form-group">
                                    <div class="col-md-11">
            ...
            $('#ff').form('submit', {
                ...
                success: function(data) {
                    ...
                    if (reqId == '') {
                        ...
                        $.messager.alertLink('Info', datas[0], 'info', "app/index/issue_po_add/?reqId=" + reqId);
                    }
                    reseti();
         ...
         function pilih_hpp(vdata){
            ...
            $.get("web/project_hpp_new_json/ambil_detail?&reqId=" + id,
                function(data) {
                 ...
                 $("#reqNomerPo").val(obj['nomer']);
            $("#reqNomerPo2").val(obj['nomer']); 
                  ...
                  $('#reqCompanyId').val(obj['company_id']);
                  $('#reqAddress').val(obj['adrress']);
                  $('#reqContact').val(obj['cp1_name']);
                  $('#reqEmail').val(obj['email']);
                  $('#reqTelp').val(obj['cp1_telp']);
                  $('#reqHp').val(obj['phone']);
                  $('#reqFax').val(obj['fax']);

                     $('#reqMaker').combobox('setValue',obj['master_project_id']);
                   $('#reqNamaProject').val(obj['nama_project2']);
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
        function tambahPenyebab(filename='') {
            ...
            $.get("app/loadUrl/app/tempalate_row_attacment2?id="+id+"&filename="+filename, function(data) {

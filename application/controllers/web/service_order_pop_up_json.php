...
class service_order_pop_up_json extends CI_Controller
{
    ...
    function json()
    {
        ...
        $aColumns = array(
            ...
            "EQUIPMENT", "DATE_OF_SERVICE","CONTACT_PERSON","SCOPE_OF_WORK","SURVEYOR_COST","OPERATOR_COST"
        );
        $aColumnsAlias = array(
            "SO_ID", "NO_ORDER", "PROJECT_NAME", "COMPANY_NAME", "VESSEL_NAME", "VESSEL_TYPE", "SURVEYOR", "DESTINATION", "SERVICE", "DATE_OF_START", "DATE_OF_FINISH",
            "EQUIPMENT", "DATE_OF_SERVICE","CONTACT_PERSON","SCOPE_OF_WORK","SURVEYOR_COST","OPERATOR_COST"
...
$allRecord = $serviceOrder->getCountByParamsPopUp(array(), $statement_privacy . $statement);
        // echo $allRecord;exit;
if ($_GET['sSearch'] == "")
    $allRecordFilter = $allRecord;
else
    $allRecordFilter =  $serviceOrder->getCountByParamsPopUp(array(), $statement_privacy . $statement);

$serviceOrder->selectByParamsPopUp(array(), $dsplyRange, $dsplyStart, $statement_privacy . $statement, $sOrder);

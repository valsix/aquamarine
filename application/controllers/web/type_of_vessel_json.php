...
class type_of_vessel_json  extends CI_Controller
{
	...
	function add()
	{
		...
		$type_of_vessel->setField("TYPE_OF_VESSEL_ID", $reqId);
		$type_of_vessel->setField("NAME", $reqName);
		$type_of_vessel->setField("DESCRIPTION", $reqDescription);
		if(empty($reqId)){
			$type_of_vessel->insert();
		}else{
			$type_of_vessel->update();	
		}

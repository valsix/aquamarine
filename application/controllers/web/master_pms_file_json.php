...
class master_pms_file_json  extends CI_Controller
{
    ...
    function json()
    {
        ...
        $aColumns = array("MASTER_PMS_FILE_ID","NAME","KETERANGAN","PATH","DOWNLOAD","AKSI");
        $aColumnsAlias = array("MASTER_PMS_FILE_ID","NAME","KETERANGAN","PATH","DOWNLOAD","AKSI");
        /*
		 * Ordering
		 */
 ...
 $nom=0;
        while ($document_attacment->nextRow()) {
            ...
            for ($i = 0; $i < count($aColumns); $i++) {
                if ($aColumns[$i] == "NO_PROJECT") {
                ...
                } else if ($aColumns[$i] == "DOWNLOAD") {
                     $file='';
                     if(!empty($reqPath)){
                        $berkas = "openAdd('uploads/master_list_equip/". $ids."/".$reqPath."');";
                          $file ='   <a onclick="'.$berkas.'" style="margin-left: 20px"><i class="fa fa-download fa-lg"></i></a><span class="nama-temp-file"> <?= $reqPath ?> </span>';
                     }
                    ...
                    $link= "'uploads/master_list_experince/".$ids."/".$reqPath."'";
    ...
    function add(){
        ...
        $document_attacment->setField("MASTER_PMS_FILE_ID", $reqId);
        $document_attacment->setField("NAME", $reqName);
        $document_attacment->setField("KETERANGAN", $reqDesciption);

...
class master_list_experince_json  extends CI_Controller
{
    ...
    function json()
    {
        ...
        $aColumnsAlias = array("MASTER_LIST_EXPERINCE_ID","NAME","KETERANGAN","PATH","AKSI");
        /*
		 * Ordering
		 */
 ...
 $nom=0;
        while ($document_attacment->nextRow()) {
            ...
            for ($i = 0; $i < count($aColumns); $i++) {
                if ($aColumns[$i] == "NO_PROJECT") {
                    ...
                    $link= "'uploads/master_list_experince/".$ids."/".$document_attacment->getField("PATH")."'";
    ...
    function add(){
        ...
        $document_attacment->setField("MASTER_LIST_EXPERINCE_ID", $reqId);

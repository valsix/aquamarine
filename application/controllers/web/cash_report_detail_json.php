...
class cash_report_detail_json extends CI_Controller
{
    ...
    function add()
    {
        ...
        $cash_report_detil->setField("TANGGAL", dateToDBCheck($reqDetailTanggal));
    ...
    function generate_fifo($reqId){
        ...
        for($i=0;$i<count($arrData);$i++){
            ...
            $cash_report_detil->setField("DEBET", ValToNull($reqDebet));
            $cash_report_detil->setField("KREDIT", ValToNull($reqKredit));
            $cash_report_detil->setField("SALDO", ValToNull($reqBalanceAwal));
            $cash_report_detil->setField("CASH_REPORT_ID", $reqId);
            ...
            $cash_report_detil = new CashReportDetil();
            $cash_report_detil->setField("CASH_REPORT_DETIL_ID", $arrData[$i]["CASH_REPORT_DETIL_ID"]);
            $cash_report_detil->setField("DEBET_USD", ValToNull($reqDebet_usd));
            $cash_report_detil->setField("KREDIT_USD", ValToNull($reqKredit_usd));
            $cash_report_detil->setField("SALDO_USD", ValToNull($reqBalanceAwal_usd));
            $cash_report_detil->setField("CASH_REPORT_ID", $reqId);

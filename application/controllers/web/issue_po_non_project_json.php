...
class issue_po_non_project_json extends CI_Controller
{
	...
	function json()
	{
		...
		$aColumns		= array("ISSUE_PO_ID","NO","NOMER_PO","PO_DATE","COMPANY_NAME","CONTACT","DESCRIPTION","TOTAL","STATUS_KET","DOC_LAMPIRAN","FINANCE","ADDRESS","EMAIL","TELP","FAX","HP","BUYER_ID","OTHER","PPN","PPN_PERCENT");
		$aColumnsAlias	= array("ISSUE_PO_ID","NO","NOMER_PO","PO_DATE","COMPANY_NAME","CONTACT","DESCRIPTION","TOTAL","STATUS_KET","DOC_LAMPIRAN","FINANCE","ADDRESS","EMAIL","TELP","FAX","HP","BUYER_ID","OTHER","PPN","PPN_PERCENT");

...
class master_lokasi_json extends CI_Controller
{
	...
	function json()
	{
		...
		$dokumen = new MasterLokasi();
		// var_dump($dokumen);
		// echo $reqKategori;exit;

		$aColumns		= array("MASTER_LOKASI_ID","NAMA","KETERANGAN","AKSI");
		$aColumnsAlias	= array("MASTER_LOKASI_ID","NAMA","KETERANGAN","AKSI");
		...
		if (isset($_GET['iSortCol_0'])) {
			...
			if (trim($sOrder) == "ORDER BY A.MASTER_LOKASI_ID asc") {
				/*
				...
				*/
				$sOrder = " ORDER BY A.MASTER_LOKASI_ID desc";
			}
		}
	...
	function delete(){
		...
		$bank = new MasterLokasi();
		$bank->setField('MASTER_LOKASI_ID',$reqId);
		$bank->delete();

...
class weekly_proses_json   extends CI_Controller
{
		...
		function json()
    {
        ...
        $aColumns = array("WEEKLY_PROSES_ID","DEPARTEMENT_ID","MASALAH","TANGGAL_MASALAH","CREATED_BY","CREATED_DATE","UPDATED_BY","UPDATED_DATE","WEEKLY_PROSES_ID");
        $aColumnsAlias =array("WEEKLY_PROSES_ID","DEPARTEMENT_ID","MASALAH","TANGGAL_MASALAH","CREATED_BY","CREATED_DATE","UPDATED_BY","UPDATED_DATE","WEEKLY_PROSES_ID");
        /*
		 * Ordering
		 */

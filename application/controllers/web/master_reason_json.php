...
class master_reason_json extends CI_Controller
{
	...
	function json()
	{
		...
		$dokumen = new MasterReason();
		// var_dump($dokumen);
		// echo $reqKategori;exit;

		$aColumns		= array("MASTER_REASON_ID","NAMA","KETERANGAN","AKSI");
		$aColumnsAlias	= array("MASTER_REASON_ID","NAMA","KETERANGAN","AKSI");
	...
	function delete(){
		...
		$bank = new MasterReason();
		$bank->setField('MASTER_REASON_ID',$reqId);
		$bank->delete();

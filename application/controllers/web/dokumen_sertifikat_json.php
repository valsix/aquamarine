...
class dokumen_sertifikat_json  extends CI_Controller
{
    ...
    function json()
    {
        ...
        $aColumns = array(
            "DOCUMENT_ID", "NAME", "ISSUED_DATE", "EXPIRED_DATE", "SURVEYOR","STATUS"
        );
        $aColumnsAlias = array(
            "DOCUMENT_ID", "NAME", "ISSUED_DATE", "EXPIRED_DATE", "SURVEYOR","STATUS"
        );
    ...
    function delete()
    {
        ...
        $dokumen_certificate->setField('DOKUMEN_SERTIFIKAT_ID', $reqId);

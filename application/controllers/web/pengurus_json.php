...
class pengurus_json extends CI_Controller
{
	...
	function json()
	{
		...
		if ($reqCabangId == "") {
			...
			$statement .= " AND CABANG_ID = '" . $reqCabangId . "' ";
	...
	function add()
	{
		...
		$reqJabatanPengurus 					= $this->input->post("reqJabatanPengurus");
		...
		$pengurus->setField("CABANG_ID", $reqCabangId);
		$pengurus->setField("NIP", $reqNip);
		$pengurus->setField("URUT", $reqUrut);
		$pengurus->setField("NAMA", $reqNama);
		$pengurus->setField("JABATAN", $reqJabatan);
		$pengurus->setField("JABATAN_PENGURUS", $reqJabatanPengurus);
		$pengurus->setField("TANGGAL_MULAI", dateToDBCheck($reqTanggalMulai));
		$pengurus->setField("TANGGAL_AKHIR", dateToDBCheck($reqTanggalAkhir));

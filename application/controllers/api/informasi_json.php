...
class informasi_json extends REST_Controller {
    ...
    // show data entitas
    function index_get() {
        $aColumns = array("SLIDER_ID", "TANGGAL", "NAMA", "KETERANGAN", "LINK_FILE", "JENIS");
        ...
        {  
            ...
            $slider->selectByParams(array("A.STATUS_PUBLISH" => "Y"), -1, -1, $statement, $order);

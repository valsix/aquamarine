...
var dlg=_2b2(opts);
return dlg;
},alertReload:function(_2b6,msg,icon,fn, ilink){
var opts=typeof _2b6=="object"?_2b6:{title:_2b6,msg:msg,icon:icon,fn:fn};
var cls=opts.icon?"messager-icon messager-"+opts.icon:"";
opts=$.extend({},$.messager.defaults,{content:"<div class=\""+cls+"\"></div>"+"<div>"+opts.msg+"</div>"+"<div style=\"clear:both;\"/>"},opts);
if(!opts.buttons){
...
var dlg=_2b2(opts);
return dlg;
},alertParentLink:function(_2b6,msg,icon,fn, ilink){
var opts=typeof _2b6=="object"?_2b6:{title:_2b6,msg:msg,icon:icon,fn:fn};
var cls=opts.icon?"messager-icon messager-"+opts.icon:"";
opts=$.extend({},$.messager.defaults,{content:"<div class=\""+cls+"\"></div>"+"<div>"+opts.msg+"</div>"+"<div style=\"clear:both;\"/>"},opts);
if(!opts.buttons){
opts.buttons=[{text:opts.ok,onClick:function(){
top.document.getElementById('mainFrame').src = ilink;
_2ad(dlg);
}}];
}
var dlg=_2b2(opts);
return dlg;
},alertParentLinkClose:function(_2b6,msg,icon,fn, ilink){
var opts=typeof _2b6=="object"?_2b6:{title:_2b6,msg:msg,icon:icon,fn:fn};
var cls=opts.icon?"messager-icon messager-"+opts.icon:"";
opts=$.extend({},$.messager.defaults,{content:"<div class=\""+cls+"\"></div>"+"<div>"+opts.msg+"</div>"+"<div style=\"clear:both;\"/>"},opts);
if(!opts.buttons){
...
var dlg=_2b2(opts);
return dlg;
},alertClose:function(_2b6,msg,icon,fn, ilink){
var opts=typeof _2b6=="object"?_2b6:{title:_2b6,msg:msg,icon:icon,fn:fn};
var cls=opts.icon?"messager-icon messager-"+opts.icon:"";
opts=$.extend({},$.messager.defaults,{content:"<div class=\""+cls+"\"></div>"+"<div>"+opts.msg+"</div>"+"<div style=\"clear:both;\"/>"},opts);
if(!opts.buttons){

...
<html>
    <head>
        ...
        <link rel="stylesheet" href="lib/jplayer.blue.monday.min.css" />
        ...
        <script src="lib/jquery-1.12.4.min.js" integrity="sha256-ZosEbRLbNQzLpnKIkEdrPv7lOy9C27hHQ+Xp8a4MxAQ=" crossorigin="anonymous"></script>
        <script src="lib/jquery-ui.min.js" integrity="sha256-VazP97ZCwtekAsvgPBSUwPFKdrwD3unUfSGVYrahUqU=" crossorigin="anonymous"></script>
        <script src="js/plugins.js?v=<?php echo $version; ?>"></script>
        <script src="lib/jquery.jplayer.min.js"></script>
        <link type="text/css" href="lib/tui-color-picker.css" rel="stylesheet">
        <script type="text/javascript" src="lib/fabric.js"></script>
        <script type="text/javascript" src="lib/tui-code-snippet.min.js"></script>
        <script type="text/javascript" src="lib/FileSaver.min.js"></script>
        <script type="text/javascript" src="lib/tui-color-picker.js"></script>
